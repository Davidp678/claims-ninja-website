...
export const SITE_FAQ: Record<SiteFaqPageKey, SiteFaqConfig> = {
  ...
  caseStudies: {
    topic: "recovery results and partnership outcomes",
    faqIds: [
      "case-studies-actual-outcomes",
      "case-studies-contractor-types",
      "case-studies-recovery-increase",
      "case-studies-commercial-claims",
      "case-studies-denied-items",
      "case-studies-carrier-negotiation",
      "case-studies-claims-reviewed",
      "getting-started-intake-info",
      "case-studies-catastrophe-claims",
