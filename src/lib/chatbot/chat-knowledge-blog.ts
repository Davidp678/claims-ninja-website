...
> = {
  ...
  "why-commercial-insurance-claims-get-underpaid": {
    phrases: [
      ...
      "commercial restoration claims underpaid",
      "commercial claims underpaid documentation",
      "tenant improvements commercial claim underpayment",
      "code ordinance commercial claim underpayment",
      "commercial estimate accuracy underpayment",
    ],
    keywords: [
  ...
  "why-carrier-estimates-miss-required-trades": {
    phrases: [
      "why carrier estimates miss required trades",
      "carrier estimate missing required trades",
      "insurance estimate left out a trade",
      "why is reconstruction work missing from estimate",
      "reconstruction work missing from estimate",
      "reconstruction work missing",
      "why is reconstruction work",
      "trade sequencing missing scope",
      "omitted trades insurance estimate",
      "incomplete insurance estimate scope trades",
      "why required trades missing from carrier estimate",
    ],
    keywords: [
      "required trades",
      "missing trades",
