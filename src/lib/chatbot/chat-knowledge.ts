...
> = {
  ...
  "commercial-insurance-supplements": {
    phrases: [
      ...
      "missing commercial scope on carrier estimate supplement",
      "missing commercial scope on carrier estimate",
      "missing commercial scope supplement",
    ],
    keywords: [
      "commercial insurance supplements",
  ...
  "documentation-supporting-missing-scope": {
    phrases: [
      ...
      "what supports omitted scope",
      "supports omitted scope",
      "how to prove missing scope on a supplement",
      "prove missing scope on a supplement",
      "prove missing scope",
    ],
    keywords: [
  ...
  "scope-audit-for-contractors": {
    phrases: [
      ...
      "what is a scope audit for contractors",
      "scope audit for contractors",
      "contractor scope audit definition",
    ],
    keywords: [
      "scope audit",
      "estimate scope",
  ...
  "auditing-insurance-estimates-for-contractors": {
    phrases: [
      "how do contractors audit insurance estimates for missing scope",
      "auditing insurance estimates for contractors",
      "audit insurance estimate scope",
      "contractor insurance estimate audit",
    ],
    keywords: [
      "auditing insurance estimates",
      "missing scope",
      "scope comparison",
      "scope audit",
    ],
  ...
  "missing-scope-contractor-audit": {
    phrases: [
      "how do contractors identify missing scope during an insurance estimate audit",
      "identify missing scope during estimate audit",
      "missing scope contractor audit",
      "omitted work on carrier estimate",
    ],
    keywords: [
      "missing scope",
      "omitted work",
  ...
  "reviewing-insurance-estimate-scope": {
    phrases: [
      "how should contractors review insurance estimate scope for completeness",
      "reviewing insurance estimate scope",
      "review estimate scope for completeness",
      "contractor estimate scope review",
    ],
    keywords: [
  ...
  "documenting-omitted-work-insurance-estimates": {
    phrases: [
      "how should contractors document omitted work on insurance estimates",
      "documenting omitted work on insurance estimates",
      "document omitted work insurance estimate",
      "how to document missing scope on estimates",
      "how do i document missing line items",
      "document missing line items insurance estimate",
      "carrier estimate left out work",
      "carrier estimate left out",
      "left out work documentation",
    ],
    keywords: [
  ...
  "documenting-detach-reset-missing-line-items": {
    phrases: [
      ...
      "documenting detach reset missing line items",
      "missing detach and reset items",
      "document detach reset on insurance estimates",
    ],
    keywords: [
      "detach reset documentation",
      "detach reset",
      "missing detach reset",
      "contents handling documentation",
    ],
    topics: ["supplements", "documentation"],
  },
  "documenting-trade-sequencing-omitted-work": {
    phrases: [
      "how should contractors document trade sequencing for omitted work",
      "documenting trade sequencing omitted work",
      "document trade sequencing on insurance estimates",
      "trade sequencing documentation for missing scope",
    ],
    keywords: [
      "trade sequencing documentation",
      "phase checklist",
      "sequencing omissions",
      "predecessor work",
    ],
    topics: ["supplements", "documentation"],
  },
  ...
  "why-missing-line-items-remain-unsupported": {
    phrases: [
      ...
      "why missing line items remain unsupported",
      "why omitted work stays unsupported",
      "missing line items unsupported evidence",
    ],
    keywords: [
      "unsupported missing line items",
      "weak evidence",
      "needs more evidence",
      "unlabeled photos",
    ],
