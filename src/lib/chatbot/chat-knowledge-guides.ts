...
> = {
  ...
  "mold-remediation-documentation-guide": {
    phrases: [
      ...
      "containment documentation mold",
      "remediation photos required",
      "equipment logs mold remediation",
  ...
  "indoor-air-quality-testing-documentation-guide": {
    phrases: [
      "indoor air quality testing documentation guide",
      "IAQ testing documentation mold",
      "document IAQ testing for insurance",
      "how should contractors document indoor air quality testing",
      ...
      "mold air sampling documentation",
      "clearance testing documentation mold",
      "mold laboratory report documentation",
      "document mold testing for insurance claims",
      "IAQ and testing documentation guide",
      "indoor air quality and testing documentation",
    ],
    keywords: [
      "IAQ documentation",
      ...
      "mold lab reports",
      "mold testing documentation",
      "chain of custody mold",
      "IAQ testing",
    ],
    topics: ["mold_claims", "documentation", "mitigation"],
  },
  "commercial-mold-claims-guide": {
    phrases: [
      "commercial mold claims guide",
      "commercial mold claims documentation",
      "document commercial mold claims",
      "how do commercial mold claims differ",
      "commercial mold claim organization",
      "multi-unit mold claim documentation",
      "phased commercial mold remediation documentation",
      "organize documentation for commercial mold",
      "commercial mold insurance documentation",
      "large loss mold documentation",
      "how do i document commercial mold damage",
    ],
    keywords: [
      "commercial mold",
  ...
  "multifamily-apartment-insurance-claims-guide": {
    phrases: [
      ...
      "how do apartment insurance claims work",
      "document multifamily insurance claims",
      "unit inspections apartment claims",
      "common areas multifamily claims",
      "property managers apartment insurance claims",
      "apartment complex insurance claim documentation",
    ],
    keywords: [
      "apartment insurance claims",
      "multifamily insurance claims",
  ...
  "hoa-insurance-claims-guide": {
    phrases: [
      ...
      "how do HOA insurance claims work",
      "document association insurance claims",
      "association master policies",
      "common elements HOA claims",
      "HOA claim coordination boards",
  ...
  "industrial-warehouse-insurance-claims-guide": {
    phrases: [
      ...
      "how do warehouse insurance claims work",
      "document industrial property insurance claims",
      "equipment documentation industrial claims",
      "warehouse inspections insurance claims",
      "industrial restoration claims",
      "manufacturing facility insurance claims",
  ...
  "commercial-fire-claims-guide": {
    phrases: [
      ...
      "large loss fire documentation",
      "commercial fire claim tenant",
      "business interruption documentation contractor fire",
      "commercial fire supplement opportunities",
      "how do i document commercial fire damage",
      "commercial fire claim workflow",
      "multi-tenant fire claim documentation",
    ],
    keywords: [
      "commercial fire",
      "large loss fire",
