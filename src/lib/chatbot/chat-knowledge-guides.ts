...
> = {
  ...
  "insurance-estimate-review-scope-validation-guide": {
    phrases: [
      ...
      "insurance estimate review & scope validation guide",
      "estimate review and scope validation guide for contractors",
      "scope validation guide for contractors",
      "how to validate scope on a carrier estimate",
      "quantity validation insurance estimates",
      "anatomy of a carrier estimate",
      "estimate review checklist for contractors",
    ],
    keywords: [
      "estimate review",
      "scope validation",
  ...
  "quantity-validation-guide-for-contractors": {
    phrases: [
      "quantity validation guide for contractors",
      "quantity validation guide",
      "how do i validate estimate quantities",
      "insurance estimate quantity validation",
      "estimate quantity review for contractors",
      "validate quantities on insurance estimates",
      ...
      "contractor estimate quantity review",
    ...
    keywords: [
      ...
      "quantity comparison worksheet",
      "roofing quantity validation",
      "interior quantity validation",
    ],
  ...
  "scope-audit-guide-for-contractors": {
    phrases: [
      "scope audit guide for contractors",
      "scope audit guide",
      "how do i audit estimate scope",
      "insurance estimate scope review",
      "contractor scope audit",
      "audit scope on insurance estimates",
      "missing scope insurance estimates",
      "omitted work on insurance estimates",
      "reviewing insurance estimate scope",
      "identify missing scope on insurance estimates",
    ],
    keywords: [
      "scope audit",
      "insurance estimate scope review",
  ...
  "missing-line-item-documentation-guide-for-contractors": {
    phrases: [
      "missing line item documentation guide for contractors",
      "missing line item documentation guide",
      "how do i document missing line items",
      "document missing line items on insurance estimates",
      ...
      "missing scope documentation for contractors",
      "contractor supplement documentation for omitted work",
      "support omitted work with documentation",
    ],
    keywords: [
  ...
  "general-conditions-documentation-guide-for-contractors": {
    phrases: [
      "general conditions documentation guide for contractors",
      "general conditions documentation guide",
      "how do contractors document general conditions",
      "document general conditions",
      "general conditions documentation restoration",
      "documenting project supervision",
      "documenting trade coordination",
      "restoration project site logistics",
      "general conditions on commercial restoration project",
      "general conditions on commercial restoration",
    ...
    keywords: [
      ...
      "temporary facilities documentation",
  ...
  "commercial-insurance-supplement-playbook-for-contractors": {
    phrases: [
      "commercial insurance supplement playbook",
      "commercial insurance supplement playbook for contractors",
      ...
      "how to submit a commercial insurance supplement",
      "commercial supplement workflow for contractors",
    ...
    keywords: [
      "commercial supplement playbook",
      "commercial insurance supplement",
      "commercial supplement workflow",
  ...
  "retail-office-insurance-claims-guide": {
    phrases: [
      ...
      "commercial restoration documentation",
      "how do retail property insurance claims work",
      "how do office building insurance claims work",
      "document retail office tenant improvements",
      "multi-tenant commercial damage documentation",
      "occupied commercial business restoration",
