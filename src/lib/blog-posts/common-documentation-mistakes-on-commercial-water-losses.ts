...
export const commonDocumentationMistakesOnCommercialWaterLosses: BlogPost = {
  slug: "common-documentation-mistakes-on-commercial-water-losses",
  title: "Common Documentation Mistakes on Commercial Water Losses",
  excerpt:
  ...
  seoTitle:
    "Common Documentation Mistakes on Commercial Water Losses | Water Damage Claims Guide",
  seoDescription:
    "Learn the most common documentation mistakes that lead to reduced payments on commercial water losses, including missing moisture maps, dry logs, equipment records, tenant impacts, and monitoring documentation.",
  relatedPostSlugs: [
  ...
  sections: [
    {
      ...
      links: [
        ...
        {
          label: "What documentation is commonly missing from commercial water claims?",
          href: "/faq#faq-water-commercial-documentation-missing",
        },
        {
    ...
    {
      id: "why-commercial-water-claims-face-more-documentation-scrutiny",
      heading: "Why Commercial Water Claims Face More Documentation Scrutiny",
      paragraphs: [
    ...
    {
      id: "mistake-1-incomplete-moisture-mapping",
      heading: "Mistake #1: Incomplete Moisture Mapping",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Are moisture maps required for insurance claims?",
    ...
    {
      id: "mistake-2-poor-dry-log-documentation",
      heading: "Mistake #2: Poor Dry Log Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-3-weak-equipment-documentation",
      heading: "Mistake #3: Weak Equipment Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why do carriers reduce equipment charges on water claims?",
          href: "/faq#faq-water-equipment-charge-reductions",
        },
        {
          label: "What documentation supports equipment on mitigation invoices?",
          href: "/faq#faq-water-equipment-invoice-documentation",
        },
      ],
    },
    {
      id: "mistake-4-failure-to-document-tenant-impact",
      heading: "Mistake #4: Failure to Document Tenant Impact",
      paragraphs: [
      ...
      links: [
        {
          label: "Should tenant impacts be documented on commercial water losses?",
          href: "/faq#faq-water-commercial-tenant-impact-required",
        },
        {
    ...
    {
      id: "mistake-5-missing-common-area-documentation",
      heading: "Mistake #5: Missing Common Area Documentation",
      paragraphs: [
      ...
      links: [
        {
          label: "How should common areas be documented during commercial water mitigation?",
    ...
    {
      id: "mistake-6-incomplete-daily-monitoring-records",
      heading: "Mistake #6: Incomplete Daily Monitoring Records",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What happens when daily monitoring records are missing?",
          href: "/faq#faq-water-missing-daily-monitoring",
        },
      ],
    },
    {
      id: "mistake-7-weak-narrative-documentation",
      heading: "Mistake #7: Weak Narrative Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-8-documentation-that-does-not-match-the-invoice",
      heading: "Mistake #8: Documentation That Does Not Match the Invoice",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why are commercial water mitigation invoices reduced?",
          href: "/faq#faq-water-commercial-invoice-reduced-why",
        },
        {
          label: "What are common water mitigation invoice review failures?",
          href: "/faq#faq-water-mitigation-invoice-review-failures",
        },
      ],
    },
    {
      id: "commercial-water-loss-documentation-checklist",
      heading: "Commercial Water Loss Documentation Checklist",
      paragraphs: [
      ...
      callout: {
        title: "Commercial water loss documentation checklist",
        body: "Moisture maps · Dry logs · Monitoring reports · Equipment logs · Tenant impact records · Common area documentation · Daily photos · Final dry verification",
      },
      links: [
        {
          label: "What should be included in a commercial mitigation package?",
          href: "/faq#faq-water-commercial-mitigation-package",
        },
        {
