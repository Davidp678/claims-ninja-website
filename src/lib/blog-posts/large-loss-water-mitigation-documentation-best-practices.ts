...
export const largeLossWaterMitigationDocumentationBestPractices: BlogPost = {
  slug: "large-loss-water-mitigation-documentation-best-practices",
  title: "Large-Loss Water Mitigation Documentation Best Practices",
  excerpt:
  ...
  seoTitle: "Large-Loss Water Mitigation Documentation Best Practices",
  seoDescription:
    "Learn large-loss water mitigation documentation best practices, including moisture mapping, equipment tracking, daily reporting, occupant impact documentation, vendor coordination, and executive-level claim reporting.",
  relatedPostSlugs: [
  ...
  sections: [
    ...
    {
      id: "why-large-loss-claims-require-different-documentation",
      heading: "Why Large-Loss Claims Require Different Documentation",
      paragraphs: [
      ...
      links: [
        {
          label: "Why are large-loss water claims heavily scrutinized?",
          href: "/faq#faq-water-large-loss-scrutiny",
        },
        {
    ...
    {
      id: "establish-a-documentation-command-structure-early",
      heading: "Establish a Documentation Command Structure Early",
      paragraphs: [
      ...
      callout: {
        title: "Command structure principle",
        body: "Large-loss documentation should be managed intentionally rather than collected reactively.",
      },
      links: [
        {
        ...
        {
          label: "How should large-loss water damage be documented?",
          href: "/faq#faq-water-large-loss-documentation",
        },
      ],
    },
    {
      id: "track-multiple-work-areas-separately",
      heading: "Track Multiple Work Areas Separately",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should multiple drying zones be documented?",
          href: "/faq#faq-water-large-loss-drying-zones",
        },
        {
          label: "Commercial water loss documentation guide",
          href: "/resources/guides/water-damage/commercial-water-loss-documentation-guide",
    ...
    {
      id: "scale-moisture-mapping-across-the-entire-loss",
      heading: "Scale Moisture Mapping Across the Entire Loss",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Are moisture maps required for water damage claims?",
          href: "/faq#faq-water-moisture-maps-required",
        },
      ],
    },
    {
      id: "maintain-comprehensive-daily-reporting",
      heading: "Maintain Comprehensive Daily Reporting",
      paragraphs: [
    ...
    {
      id: "track-equipment-by-zone-and-area",
      heading: "Track Equipment by Zone and Area",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should equipment usage be documented for invoice review?",
          href: "/faq#faq-water-equipment-invoice-documentation",
        },
      ],
    },
    {
      id: "document-occupant-and-operational-impacts",
      heading: "Document Occupant and Operational Impacts",
      paragraphs: [
    ...
    {
      id: "coordinate-vendor-and-subcontractor-documentation",
      heading: "Coordinate Vendor and Subcontractor Documentation",
      paragraphs: [
    ...
    {
      id: "create-executive-level-reporting",
      heading: "Create Executive-Level Reporting",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What documentation supports large commercial water mitigation invoices?",
          href: "/faq#faq-water-large-loss-invoice-documentation",
        },
      ],
    },
    {
      id: "common-large-loss-documentation-failures",
      heading: "Common Large-Loss Documentation Failures",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Large-Loss Documentation Checklist",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Moisture maps · Daily reports · Dry logs · Equipment logs · Vendor documentation · Occupant impact records · Executive summaries · Final dry verification",
      },
      links: [
        {
          label: "How should large-loss water damage be documented?",
