...
export const odorMitigationInFireDamageClaims: BlogPost = {
  slug: "odor-mitigation-in-fire-damage-claims",
  title: "Odor Mitigation in Fire Damage Claims",
  excerpt:
  ...
  seoTitle: "Odor Mitigation in Fire Damage Claims",
  seoDescription:
    "Odor mitigation in fire damage claims for contractors: assessment, smoke odor removal documentation, thermal fogging and hydroxyl treatments, supplements, and fire restoration claim support.",
  relatedPostSlugs: [
  ...
  faq: [
    {
      question: "Why does odor mitigation matter on fire claims?",
      answer:
    ...
    {
      question: "How do carriers evaluate odor mitigation claims?",
      answer:
    ...
    {
      question: "How should odor be documented before treatment?",
      answer:
    ...
    {
      question: "What documentation supports thermal fogging claims?",
      answer:
    ...
    {
      question: "What is the difference between ozone and hydroxyl documentation?",
      answer:
    ...
    {
      question: "When is sealing supported on fire odor claims?",
      answer:
    ...
    {
      question: "How does HVAC affect odor mitigation documentation?",
      answer:
    ...
    {
      question: "How should contents odor be documented?",
      answer:
    ...
    {
      question: "What supports post-treatment odor verification?",
      answer:
    ...
    {
      question: "Why are odor supplements denied?",
      answer:
    ...
    {
      question: "When should odor supplements be submitted?",
      answer:
    ...
    {
      question: "Can AI help with odor documentation review?",
      answer:
  ...
  sections: [
    ...
    {
      id: "why-odor-matters",
      heading: "Why odor mitigation matters after fire losses",
      paragraphs: [
    ...
    {
      id: "smoke-odors-affect-structures",
      heading: "How smoke odors affect structures and contents",
      paragraphs: [
    ...
    {
      id: "why-odor-misunderstood",
      heading: "Why odor damage is often misunderstood",
      paragraphs: [
    ...
    {
      id: "how-carriers-evaluate-odor",
      heading: "How carriers evaluate odor mitigation claims",
      paragraphs: [
    ...
    {
      id: "how-odor-migrates",
      heading: "How odor migrates through structures",
      paragraphs: [
    ...
    {
      id: "common-odor-issues",
      heading: "Common odor-related issues",
      paragraphs: [
    ...
    {
      id: "issue-structural-odor",
      heading: "Structural odor",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-contents-odor",
      heading: "Contents odor",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-hvac-odor-transfer",
      heading: "HVAC odor transfer",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-hidden-odor-sources",
      heading: "Hidden odor sources",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-secondary-contamination",
      heading: "Secondary contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "odor-assessment-process",
      heading: "Odor assessment process",
      paragraphs: [
    ...
    {
      id: "assessment-initial-inspection",
    ...
    {
      id: "assessment-room-by-room",
      heading: "Room-by-room evaluation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "assessment-source-identification",
      heading: "Odor source identification",
      level: 3,
      paragraphs: [
    ...
    {
      id: "assessment-documentation-procedures",
      heading: "Documentation procedures",
      level: 3,
      paragraphs: [
      ...
      callout: {
        ...
        body: "Log odor before first cleaning pass in every affected room — one dated sentence per room beats a paragraph written at invoice. Pre-treatment logs are the foundation every odor line item rests on at desk review.",
      },
    },
    {
      id: "assessment-specialist-evaluations",
    ...
    {
      id: "doc-hvac-observations",
      heading: "HVAC observations",
      level: 3,
      paragraphs: [
    ...
    {
      id: "doc-cleaning-records",
      heading: "Cleaning records",
      level: 3,
      paragraphs: [
    ...
    {
      id: "odor-supplement-opportunities",
      heading: "Common odor mitigation supplement opportunities",
      paragraphs: [
    ...
    {
      id: "supp-thermal-fogging",
      heading: "Thermal fogging",
      level: 3,
      paragraphs: [
    ...
    {
      id: "supp-hvac-treatment",
      heading: "HVAC treatment",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "The costliest odor mistake is running hydroxyl or ozone before pre-treatment photos and logs exist. Assess and document first; treat second; supplement with indexed evidence third — never reverse that order on a disputed file.",
      },
    },
    {
      id: "odor-and-supplements",
      heading: "How odor documentation supports supplements",
      paragraphs: [
    ...
    {
      id: "odor-and-denial-recovery",
      heading: "How odor documentation supports denial recovery",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Warning signs of under-documented odor losses",
      bullets: [
    ...
    {
      id: "audit-readiness",
      heading: "Audit readiness on odor fire files",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Assume odor lines on fire files could be audited. Dated pre-treatment logs, equipment duration records, and verification notes before final billing pass audit far more often than deodorize lines supported only by equipment rental invoices.",
      },
    },
    {
      ...
      callout: {
        ...
        body: "Add odor logging to your fire intake checklist — same urgency as migration hall photos. Bedroom odor lines with pre-treatment logs and path narrative recover scope carriers omit from origin-only first estimates.",
      },
    },
    {
      id: "claims-ninja-odor-review",
      heading: "How Claims Ninja evaluates odor mitigation opportunities",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Queue fire files where the estimate lists ozone or hydroxyl days but the attachment index has no equipment placement photos — fix before submit. AI screening saves time; it does not replace field odor assessment or verification walks.",
      },
      links: [
