...
export const fiveRedFlagsThatAnInsuranceEstimateIsMissingScope: BlogPost = {
  slug: "five-red-flags-that-an-insurance-estimate-is-missing-scope",
  title: "Five Red Flags That an Insurance Estimate Is Missing Scope",
  excerpt:
  ...
  seoTitle: "Five Red Flags an Insurance Estimate Is Missing Scope",
  seoDescription:
  ...
  sections: [
    ...
    {
      id: "why-missing-scope-is-common",
      heading: "Why Missing Scope Is Common",
      paragraphs: [
    ...
    {
      id: "red-flag-1-field-conditions-exceed-documented-scope",
      heading: "Red Flag #1 — Field Conditions Exceed Documented Scope",
      paragraphs: [
    ...
    {
      id: "red-flag-2-missing-trade-coordination",
      heading: "Red Flag #2 — Missing Trade Coordination",
      paragraphs: [
    ...
    {
      id: "red-flag-3-quantities-appear-inconsistent",
      heading: "Red Flag #3 — Quantities Appear Inconsistent",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contractors review a carrier estimate for missing scope?",
          href: "/faq#faq-carrier-estimate-review-missing-scope",
        },
      ],
    },
    {
      id: "red-flag-4-documentation-and-estimate-dont-align",
      heading: "Red Flag #4 — Supporting Documentation and Estimate Don't Align",
      paragraphs: [
    ...
    {
      id: "red-flag-5-required-work-absent-from-estimate",
      heading: "Red Flag #5 — Required Work Is Absent from the Estimate",
      paragraphs: [
    ...
    {
      id: "why-structured-estimate-review-matters",
      heading: "Why a Structured Estimate Review Process Matters",
      paragraphs: [
    ...
    {
      id: "closing",
      heading: "Closing: Turn Red Flags Into a Review Habit",
      paragraphs: [
