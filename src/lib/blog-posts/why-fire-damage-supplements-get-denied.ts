...
export const whyFireDamageSupplementsGetDenied: BlogPost = {
  slug: "why-fire-damage-supplements-get-denied",
  title:
    "Why Fire Damage Supplements Get Denied: 12 Documentation and Scope Mistakes Contractors Can Prevent",
  excerpt:
    "Why fire damage supplements get denied: 12 preventable documentation, estimating, and workflow mistakes on photos, smoke, hidden damage, contents, pack-out, code upgrades, and Xactimate organization — and how contractors build reviewer-ready fire supplement packages.",
  ...
  seoTitle: "Why Fire Damage Supplements Get Denied: 12 Preventable Mistakes",
  seoDescription:
    "Why fire damage supplements get denied: 12 preventable documentation and scope mistakes on photos, smoke, contents, code upgrades, and Xactimate — and how contractors prevent supplement denials.",
  relatedPostSlugs: [
  ...
  sections: [
    {
      ...
      links: [
        ...
        {
          label: "Why are fire damage supplements denied?",
          href: "/faq#faq-fire-supplement-denied-why",
        },
        { label: "Fire damage solutions", href: "/solutions/fire-damage" },
      ],
    },
    {
      id: "incomplete-photo-documentation",
      heading: "Reason 1: Incomplete Photo Documentation",
      paragraphs: [
    ...
    {
      id: "weak-smoke-damage-documentation",
      heading: "Reason 2: Weak Smoke Damage Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What documentation supports smoke damage on fire claims?",
          href: "/faq#faq-fire-smoke-documentation-support",
        },
        {
    ...
    {
      id: "hidden-damage-never-documented",
      heading: "Reason 3: Hidden Damage Was Never Documented",
      paragraphs: [
        "Hidden damage discovered during demolition is the highest-value supplement opportunity on fire files — and the most commonly under-documented. When framing char, compromised trusses, saturated insulation, and structural members are repaired without contemporaneous cavity photos, carriers approve patch scope instead of full replacement.",
        "Framing documentation requires char depth, heat-affected members, connector compromise, and load-path context captured during tear-out — not after drywall closes. Insulation and sheathing damage behind finished surfaces need cavity photos with date stamps before rebuild proceeds. Structural members discovered during demolition must be logged in a discovery record tied to estimate revisions.",
        "The outcome impact is predictable: unsupported hidden damage lines get denied as speculative or post-repair reconstruction. Even when field conditions clearly required replacement, desk reviewers cannot approve scope without evidence captured when access existed. Resubmission after close-in rarely recovers the same value as contemporaneous documentation.",
        "Prevent hidden damage denials by maintaining a demolition discovery log from the first wall opened, photographing every structural finding before cover-up, and submitting phased supplements while access remains. The Fire Damage Documentation Guide covers structural and discovery capture standards.",
      ],
      bullets: [
        "Photograph cavity conditions during demolition — before repairs close access",
        "Log framing, truss, sheathing, and insulation findings in a discovery record",
        "Date-stamp discovery photos and tie them to specific estimate line items",
        "Submit phased supplements while tear-out access still exists",
      ],
      links: [
        {
          label: "Fire Damage Documentation Guide",
        ...
        {
          label: "Should hidden fire damage be documented?",
          href: "/faq#faq-fire-hidden-damage-required",
        },
        {
          label: "Structural stabilization guide",
          href: "/resources/guides/fire-damage/structural-stabilization-guide",
        },
      ],
    },
    {
      id: "missing-contents-support",
      heading: "Reason 4: Missing Contents Support",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contents be documented after a fire?",
          href: "/faq#faq-contents-inventory-documentation-insurance",
        },
      ],
    },
    {
      id: "pack-out-documentation-gaps",
      heading: "Reason 5: Pack-Out Documentation Gaps",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should pack-out chain of custody be documented?",
          href: "/faq#faq-pack-out-chain-of-custody-documentation",
        },
      ],
    },
    {
      id: "code-upgrades-not-supported",
      heading: "Reason 6: Code Upgrades Were Not Properly Supported",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why are fire code upgrade supplements denied?",
          href: "/faq#faq-fire-code-upgrade-supplement-denials",
        },
        {
          label: "Does insurance cover fire code upgrades?",
          href: "/faq#faq-fire-code-upgrade-insurance-coverage",
        },
      ],
    },
    {
      id: "poor-estimate-organization",
      heading: "Reason 7: Poor Estimate Organization",
      paragraphs: [
    ...
    {
      id: "missing-narratives",
      heading: "Reason 8: Missing Narratives",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What documentation should support a fire supplement?",
          href: "/faq#faq-fire-supplement-documentation-evidence",
        },
      ],
    },
    {
      id: "commercial-complexity-overlooked",
      heading: "Reason 9: Commercial Complexity Was Overlooked",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How are commercial fire claims documented?",
          href: "/faq#faq-fire-commercial-claims-documentation",
        },
      ],
    },
    {
      id: "supplement-submitted-too-early",
      heading: "Reason 10: Supplement Submitted Too Early",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "When should contractors submit a fire supplement?",
          href: "/faq#faq-fire-supplement-when-to-submit",
        },
        {
          label: "Fire Claim Documentation Checklist",
          href: "/resources/blog/fire-claim-documentation-checklist",
    ...
    {
      id: "carrier-questions-never-addressed",
      heading: "Reason 11: Carrier Questions Were Never Addressed",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why do carriers request additional documentation during fire claims?",
          href: "/faq#faq-fire-carrier-additional-documentation-why",
        },
        {
    ...
    {
      id: "no-repeatable-workflow",
      heading: "Reason 12: No Repeatable Workflow",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What is the most common reason fire supplements fail?",
          href: "/faq#faq-fire-supplement-denial-common-reason",
        },
      ],
    },
    {
      ...
      links: [
        ...
        { label: "Fire damage guides hub", href: "/resources/guides/fire-damage" },
