...
export const whyWaterMitigationClaimsGetUnderpaid: BlogPost = {
  slug: "why-water-mitigation-claims-get-underpaid",
  title: "Why Water Mitigation Claims Get Underpaid",
  excerpt:
    "Why water mitigation claims get underpaid: documentation gaps, scope and pricing disputes, timing mistakes, and practical recovery strategies for mitigation contractors facing payment shortfalls.",
  ...
  seoTitle: "Why Water Mitigation Claims Get Underpaid",
  seoDescription:
  ...
  faq: [
    {
      question: "Why are water mitigation claims often underpaid?",
      answer:
        "Underpayment usually combines structural estimate gaps — template drying days, missing rooms, skipped line items — with weak documentation that makes legitimate scope hard to approve. Desk review, timing, and communication gaps amplify the problem; it is rarely a single cause.",
    },
    {
      question: "Is underpayment the same as a supplement denial?",
      answer:
        "Not exactly. Underpayment can mean the initial estimate was low, partial approval paid some lines, or payment lagged documented work. Denial is a formal rejection of requested scope. Many underpaid files need supplements or resubmission with better evidence, not a new fight over policy.",
    },
    {
      question: "How do dry logs affect mitigation payment?",
      answer:
        "Dry logs prove equipment days and monitoring were necessary. Missing or gapped logs are a top reason drying extensions are cut. Carriers pay chronology they can forward — not invoices alone.",
    },
    {
      question: "How do moisture maps affect payment?",
      answer:
        "Maps establish intake extent and reading points. Weak or absent maps make extra rooms and hidden moisture look like late scope inflation. Strong intake maps support initial approval and supplements.",
    },
    {
      question: "Can contractors recover underpaid mitigation scope?",
      answer:
        "Yes, when documentation supports the gap: supplements for missed lines, resubmission after partial payment, and organized evidence tied to each line item. Recovery is harder after equipment pull if logs and photos were never captured.",
    },
    {
      question: "When should I submit a water mitigation supplement?",
      answer:
        "Submit when you can document a difference between carrier scope and field reality — ideally within the first 48 hours after estimate receipt for predictable gaps, and while drying is active for duration disputes. Waiting until rebuild often weakens mitigation-only arguments.",
    },
    {
      question: "What are signs my mitigation claim is underpaid?",
      answer:
        "Warning signs include carrier sketch missing wet rooms, template drying shorter than field drying, partial approval on monitoring, payment without mapping or log support, and production absorbing scope the estimate never included.",
    },
    {
      question: "Does desk review cause underpayment?",
      answer:
        "Desk review uses macros and photos without always seeing every assembly. It speeds claims but understates complex water losses. Field documentation is how contractors bridge desk assumptions to site reality — not arguments alone.",
    },
    {
      question: "How does timing affect mitigation payment?",
      answer:
        "Late supplements, late documentation, and production before estimate review lock in under-scoped payment. Early estimate comparison, intake maps, and daily logs prevent absorbing unpaid drying and equipment.",
    },
    {
      question: "How does Claims Ninja help with underpaid water claims?",
      answer:
        "Claims Ninja compares estimates to documentation, identifies supplement opportunities, packages carrier-ready files, and supports denial and partial-approval recovery with performance-aligned fees tied to documented increases.",
    },
    {
      question: "What is the difference between scope and pricing underpayment?",
      answer:
        "Scope underpayment omits work you performed — rooms, equipment days, monitoring. Pricing underpayment pays the line but at a unit price or quantity below market or field need. Separate them in supplements: quantity and scope arguments first, unit price with invoices second.",
    },
  ],
  sections: [
    {
    ...
    {
      id: "why-underpayment-is-common",
      heading: "Why underpayment concerns are common in mitigation",
      paragraphs: [
    ...
    {
      id: "how-claims-are-evaluated",
      heading: "How water mitigation claims are evaluated",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Assume every mitigation file could be reviewed again. Contemporaneous maps, logs, and photos are the defense against both initial underpayment and later takebacks.",
      },
    },
    {
      id: "common-reasons-underpaid",
      heading: "Common reasons mitigation claims get underpaid",
      paragraphs: [
      ...
      callout: {
        title: "Common underpayment causes",
        body: "If you fix only one lever, fix documentation timing: intake map, daily dry log, labeled photos, and equipment records before invoice — not assembled after the adjuster cuts payment.",
      },
    },
    {
    ...
    {
      id: "weak-moisture-mapping",
      heading: "Weak moisture mapping",
      level: 3,
      paragraphs: [
    ...
    {
      id: "poor-equipment-tracking",
      heading: "Poor equipment tracking",
      level: 3,
      paragraphs: [
    ...
    {
      id: "missing-monitoring-records",
      heading: "Missing monitoring records",
      level: 3,
      paragraphs: [
    ...
    {
      id: "pricing-disagreements",
      heading: "Pricing disagreements",
      paragraphs: [
    ...
    {
      id: "documentation-impacts-payment",
      heading: "How documentation impacts payment outcomes",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use one room naming system across map, photos, dry log, and Xactimate. Mismatched labels are a silent cause of underpayment — adjusters pause instead of approve while reconciling rooms.",
      },
    },
    {
      id: "doc-dry-logs",
    ...
    {
      id: "missed-supplement-opportunities",
      heading: "How supplement opportunities are missed",
      paragraphs: [
    ...
    {
      id: "warning-signs-underpayment",
      heading: "Warning signs of claim underpayment",
      bullets: [
    ...
    {
      id: "claim-recovery-strategies",
      heading: "Claim recovery strategies",
      paragraphs: [
    ...
    {
      id: "improve-documentation-workflows",
      heading: "Improving documentation workflows",
      paragraphs: [
    ...
    {
      id: "claims-ninja-mitigation-support",
    ...
    {
      id: "ai-mitigation-claim-review",
      heading: "AI-assisted mitigation claim review",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use AI to sort storm books by underpayment risk — template drying mismatch, missing map upload, log day gaps — then apply human review and the water cluster guides before submit.",
      },
      links: [
