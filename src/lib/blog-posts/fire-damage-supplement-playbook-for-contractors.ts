...
export const fireDamageSupplementPlaybookForContractors: BlogPost = {
  slug: "fire-damage-supplement-playbook-for-contractors",
  ...
  seoTitle: "Fire Damage Supplement Playbook",
  seoDescription:
  ...
  faq: [
    {
      question: "What is a fire damage supplement?",
      answer:
    ...
    {
      question: "Why are fire claims commonly under-scoped?",
      answer:
    ...
    {
      question: "How are smoke damage supplements supported?",
      answer:
    ...
    {
      question: "What causes fire supplement denials?",
      answer:
    ...
    {
      question: "How long do fire supplements take?",
      answer:
    ...
    {
      question: "What are common missed line items on fire claims?",
      answer:
    ...
    {
      question: "When should fire supplements be submitted?",
      answer:
    ...
    {
      question: "How do contractors identify supplement opportunities?",
      answer:
    ...
    {
      question: "How does AI assist fire claim review?",
      answer:
    ...
    {
      question: "How does Claims Ninja help with fire supplements?",
      answer:
  ...
  sections: [
    ...
    {
      id: "what-is-fire-supplement",
      heading: "What is a fire damage supplement?",
      paragraphs: [
    ...
    {
      id: "why-fire-under-scoped",
      heading: "Why fire claims are frequently under-scoped",
      paragraphs: [
    ...
    {
      id: "how-fire-estimates-created",
      heading: "How fire estimates are created",
      paragraphs: [
    ...
    {
      id: "fire-vs-roofing-water",
      heading: "How fire losses differ from roofing and water losses",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Water mitigation supplement playbook (contrast)",
          href: "/resources/blog/water-damage-mitigation-supplement-playbook",
        },
      ],
    },
    {
      id: "commonly-missed-fire-items",
      heading: "Commonly missed fire claim line items",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Prioritize supplement evidence on smoke migration rooms, HVAC scope, contents pack-out and cleaning, demolition with pre-demo photos, and odor treatment before fighting low-dollar consumables. Carriers approve indexed migration folders more often than unexplained smoke wipe quantity increases.",
      },
    },
    {
      id: "missed-smoke-damage",
      heading: "Smoke damage",
      level: 3,
      paragraphs: [
    ...
    {
      id: "missed-soot-contamination",
      heading: "Soot contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "missed-contents-manipulation",
    ...
    {
      id: "missed-material-replacement",
      heading: "Material replacement considerations",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Use one room naming convention across photos, inventory, sketch, and estimate — claim number plus room label plus date in filenames. The fire supplement package should read as one story adjusters can forward without a callback.",
      },
      links: [
        {
          label: "Fire damage claim documentation guide",
    ...
    },
    {
      ...
      links: [
        {
          label: "Fire damage claim documentation guide (full standards)",
          href: "/resources/blog/fire-damage-claim-documentation-guide",
        },
      ],
    },
    {
      id: "fire-supplement-process",
      heading: "The fire supplement process",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "How supplement opportunities are identified",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Review fire estimates within 48 hours, run the missed-items checklist on every file, and capture migration photos before rebuild obscures paths. One caught HVAC or migration supplement per week often exceeds the cost of part-time supplement support on a busy fire book.",
      },
    },
    {
      id: "re-inspections",
    ...
    },
    {
      ...
      heading: "Common reasons fire supplements are denied",
      bullets: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Before every fire supplement submit, verify: sketch rooms match photographed rooms, HVAC lines have attachments, contents lines have inventory pages, and the cover letter maps every attachment to a line number. That five-minute audit prevents weeks of denial loops.",
      },
      links: [
        {
          label: "How documentation improves approvals",
    ...
    {
      id: "claims-ninja-fire-support",
      heading: "How Claims Ninja supports fire restoration contractors",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "AI-assisted fire claim analysis",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Queue fire files where photo metadata room tags do not match estimate room list — fix naming before supplement submit. AI screening saves time; it does not replace field capture or human sign-off on carrier submissions.",
      },
      links: [
