...
export const hailDamageRoofClaimsDocumentationSupplement: BlogPost = {
  slug: "hail-damage-roof-claims-documentation-supplement",
  title: "Hail Damage Roof Claims: Documentation & Supplement Guide",
  excerpt:
  ...
  seoTitle: "Hail Damage Roof Claims: Documentation & Supplement Guide",
  seoDescription:
    "Hail damage roof claims for contractors: document impacts, test squares, soft metals, and layered tear-off discovery to support storm supplement approvals.",
  relatedPostSlugs: [
  ...
  faq: [
    {
      question: "What photos do carriers expect for hail roof claims?",
      answer:
    ...
    {
      question: "How do test squares support hail supplements?",
      answer:
    ...
    {
      question: "Why document soft metals on hail jobs?",
      answer:
  ...
  sections: [
    ...
    {
      id: "hail-documentation-basics",
      heading: "Hail documentation basics",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Wind damage roof claims guide",
          href: "/resources/blog/wind-damage-roof-claims-what-carriers-miss",
        },
      ],
    },
    {
      id: "test-squares-soft-metals",
      heading: "Test squares and soft metals",
      bullets: [
    ...
    {
      id: "layered-tear-off",
      heading: "Layered roofing and tear-off discovery",
      paragraphs: [
    ...
    {
      id: "carrier-disputes",
      heading: "Common carrier disputes on hail files",
      bullets: [
    ...
    },
    {
      ...
      heading: "Hail supplement strategy",
      paragraphs: [
