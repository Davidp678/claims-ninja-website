...
export const whyMoldInsuranceClaimsGetUnderpaid: BlogPost = {
  slug: "why-mold-insurance-claims-get-underpaid",
  title:
  ...
  seoTitle:
    "Why Mold Insurance Claims Get Underpaid: 10 Documentation Mistakes",
  seoDescription:
  ...
  sections: [
    {
      ...
      links: [
        ...
        { label: "Mold guides hub", href: "/resources/guides/mold" },
      ],
    },
    {
      id: "mistake-1-moisture-source-never-documented",
      heading: "Mistake #1: The Moisture Source Was Never Documented",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why are mold insurance claims underpaid?",
          href: "/faq#faq-mold-claims-underpaid-why",
        },
        {
    ...
    {
      id: "mistake-2-hidden-mold-never-investigated",
      heading: "Mistake #2: Hidden Mold Was Never Investigated",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Can hidden mold affect claim payments?",
          href: "/faq#faq-mold-hidden-damage-affects-payment",
        },
        {
          label: "How should hidden mold damage be documented?",
          href: "/faq#faq-mold-hidden-damage-documentation",
        },
      ],
    },
    {
      id: "mistake-3-poor-photo-documentation",
      heading: "Mistake #3: Poor Photo Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-4-weak-moisture-documentation",
      heading: "Mistake #4: Weak Moisture Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-5-remediation-poorly-documented",
      heading: "Mistake #5: Remediation Work Was Poorly Documented",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contractors document mold remediation work?",
          href: "/faq#faq-mold-remediation-work-documentation",
        },
        {
          label: "Dry log documentation guide for insurance claims",
          href: "/resources/blog/dry-log-documentation-guide-insurance-claims",
        },
      ],
    },
    {
      id: "mistake-6-no-prv-documentation",
      heading: "Mistake #6: No PRV Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What is Post-Remediation Verification (PRV)?",
          href: "/faq#faq-mold-prv-definition",
        },
        {
          label: "What should a mold PRV closeout package include?",
          href: "/faq#faq-mold-prv-closeout-package",
        },
      ],
    },
    {
      id: "mistake-7-weak-estimate-organization",
      heading: "Mistake #7: Estimate Organization Was Weak",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What documentation improves mold insurance settlements?",
          href: "/faq#faq-mold-documentation-improves-settlement",
        },
        {
          label: "How does documentation affect mold insurance claims?",
          href: "/faq#faq-mold-documentation-affects-claim-outcomes",
        },
      ],
    },
    {
      id: "mistake-8-commercial-complexity-ignored",
      heading: "Mistake #8: Commercial Complexity Was Ignored",
      paragraphs: [
    ...
    {
      id: "mistake-9-submitted-too-early",
      heading: "Mistake #9: Documentation Was Submitted Too Early",
      paragraphs: [
    ...
    {
      id: "mistake-10-no-standard-workflow",
      heading: "Mistake #10: No Standard Documentation Workflow",
      paragraphs: [
