...
export const whyFireDamageClaimsGetUnderpaid: BlogPost = {
  slug: "why-fire-damage-claims-get-underpaid",
  title:
  ...
  sections: [
    {
      ...
      links: [
        ...
        {
          label: "Why are fire damage claims underpaid?",
          href: "/faq#faq-fire-claims-underpaid-why",
        },
        { label: "Fire damage solutions", href: "/solutions/fire-damage" },
      ],
    },
    {
      id: "incomplete-structural-documentation",
      heading: "Incomplete Structural Documentation",
      paragraphs: [
    ...
    {
      id: "poor-smoke-soot-documentation",
      heading: "Poor Smoke & Soot Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Does insurance pay for smoke damage?",
          href: "/faq#faq-fire-smoke-damage-insurance-coverage",
        },
      ],
    },
    {
      id: "weak-contents-inventories",
      heading: "Weak Contents Inventories",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contents inventory be documented for insurance?",
          href: "/faq#faq-contents-inventory-documentation-insurance",
        },
      ],
    },
    {
      id: "missing-pack-out-documentation",
      heading: "Missing Pack-Out Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should a pack-out be documented for insurance?",
          href: "/faq#faq-pack-out-documentation-insurance",
        },
        {
          label: "What chain of custody documentation is required?",
          href: "/faq#faq-pack-out-chain-of-custody-documentation",
        },
      ],
    },
    {
      id: "weak-supplement-documentation",
      heading: "Weak Supplement Documentation",
      paragraphs: [
    ...
    {
      id: "better-documentation-claim-outcomes",
      heading: "Better Documentation Leads to Better Claim Outcomes",
      paragraphs: [
