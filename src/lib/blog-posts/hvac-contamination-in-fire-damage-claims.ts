...
export const hvacContaminationInFireDamageClaims: BlogPost = {
  slug: "hvac-contamination-in-fire-damage-claims",
  title: "HVAC Contamination in Fire Damage Claims",
  excerpt:
  ...
  seoTitle: "HVAC Contamination in Fire Damage Claims",
  seoDescription:
    "HVAC contamination in fire damage claims for contractors: inspection workflows, duct and component documentation, supplements, denial recovery, and restoration claim support.",
  relatedPostSlugs: [
  ...
  faq: [
    {
      question: "How does smoke affect HVAC systems?",
      answer:
    ...
    {
      question: "Can soot contaminate ductwork?",
      answer:
    ...
    {
      question: "How is HVAC contamination documented?",
      answer:
    ...
    {
      question: "What supports HVAC cleaning claims?",
      answer:
    ...
    {
      question: "When should HVAC components be replaced?",
      answer:
    ...
    {
      question: "Why are HVAC losses disputed?",
      answer:
    ...
    {
      question: "What reports improve claim support?",
      answer:
    ...
    {
      question: "How do contractors identify HVAC contamination?",
      answer:
    ...
    {
      question: "Can HVAC contamination create supplement opportunities?",
      answer:
    ...
    {
      question: "How does HVAC documentation support denial recovery?",
      answer:
    ...
    {
      question: "How does AI help evaluate HVAC-related claims?",
      answer:
  ...
  sections: [
    ...
    {
      id: "why-hvac-critical",
      heading: "Why HVAC systems are critical in fire losses",
      paragraphs: [
    ...
    {
      id: "smoke-soot-affect-hvac",
      heading: "How smoke and soot affect HVAC systems",
      paragraphs: [
    ...
    {
      id: "why-hvac-overlooked",
      heading: "Why HVAC contamination is often overlooked",
      paragraphs: [
    ...
    {
      id: "how-carriers-evaluate-hvac",
      heading: "How carriers evaluate HVAC contamination claims",
      paragraphs: [
    ...
    {
      id: "how-contamination-spreads-ducts",
      heading: "How contamination spreads through duct systems",
      paragraphs: [
    ...
    {
      id: "common-hvac-contamination-issues",
      heading: "Common HVAC contamination issues",
      paragraphs: [
    ...
    {
      id: "issue-smoke-residue",
      heading: "Smoke residue",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-soot-deposition",
      heading: "Soot deposition",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-odor-migration",
      heading: "Odor migration",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-filter-contamination",
      heading: "Filter contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-coil-contamination",
      heading: "Coil contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-blower-contamination",
      heading: "Blower contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-duct-contamination",
      heading: "Duct contamination",
      level: 3,
      paragraphs: [
    ...
    {
      id: "issue-airflow-concerns",
      heading: "Airflow concerns",
      level: 3,
      paragraphs: [
    ...
    {
      id: "hvac-inspection-process",
      heading: "HVAC inspection process",
      paragraphs: [
    ...
    {
      id: "inspection-documentation-tips",
      heading: "Inspection documentation standards",
      level: 3,
      paragraphs: [
      ...
      callout: {
        ...
        body: "Create an HVAC subfolder separate from room smoke photos. Name files with claim number, component, and date — AHU-coil-pre-20260713.jpg. Adjusters approve HVAC scope they can map without opening unrelated migration folders.",
      },
    },
    {
      id: "inspection-system-documentation",
    ...
    {
      id: "inspection-photographic-evidence",
    ...
    {
      id: "inspection-contamination-assessment",
      heading: "Contamination assessment",
      level: 3,
      paragraphs: [
    ...
    {
      id: "inspection-specialist-evaluations",
      heading: "Specialist evaluations",
      level: 3,
      paragraphs: [
    ...
    {
      id: "doc-mechanical-components",
      heading: "Mechanical component documentation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "doc-contractor-reports",
      heading: "Contractor reports",
      level: 3,
      paragraphs: [
    ...
    {
      id: "hvac-supplement-opportunities",
      heading: "Common HVAC-related supplement opportunities",
      paragraphs: [
    ...
    {
      id: "supp-duct-remediation",
      heading: "Duct remediation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "supp-filter-replacement",
      heading: "Filter replacement",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "The costliest HVAC mistake is cleaning ducts before pre-clean photos exist. Inspect and photograph first; clean second; supplement with indexed evidence third — never reverse that order on a disputed file.",
      },
    },
    {
      id: "hvac-and-supplements",
      heading: "How HVAC documentation supports supplements",
      paragraphs: [
    ...
    {
      id: "hvac-and-denial-recovery",
      heading: "How HVAC documentation supports denial recovery",
      paragraphs: [
    ...
    {
      id: "warning-signs-under-documented",
      heading: "Warning signs of under-documented HVAC losses",
      bullets: [
    ...
    {
      id: "audit-readiness",
      heading: "Audit readiness on HVAC fire files",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Assume HVAC lines on fire files could be audited. Dated inspection photos, authored reports, and component-level index before cleaning starts pass audit far more often than duct lines supported only by post-clean invoices.",
      },
    },
    {
      id: "recovery-opportunities",
      heading: "Recovery opportunities",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Add HVAC inspection to your fire intake checklist — same urgency as migration hall photos. Catching unstained-register / stained-register contrast early builds supplement files adjusters cannot dismiss as late scope inflation.",
      },
    },
    {
      id: "claims-ninja-hvac-review",
      heading: "How Claims Ninja evaluates HVAC contamination opportunities",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Queue fire files where the estimate lists duct or coil cleaning but the attachment index has no HVAC-tagged photos — fix before submit. AI screening saves time; it does not replace equipment inspection or authored reports.",
      },
      links: [
