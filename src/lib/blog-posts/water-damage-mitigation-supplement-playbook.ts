...
export const waterDamageMitigationSupplementPlaybook: BlogPost = {
  slug: "water-damage-mitigation-supplement-playbook",
  title: "Water Damage Mitigation Supplement Playbook for Contractors",
  excerpt:
    "The contractor playbook for water mitigation supplements: drying documentation, commonly missed line items, carrier estimate review, denial prevention, and performance-aligned mitigation claim recovery.",
  ...
  seoTitle: "Water Damage Mitigation Supplement Playbook",
  seoDescription:
  ...
  faq: [
    {
      question: "What is a water mitigation supplement?",
      answer:
        "A water mitigation supplement is a formal request to revise a carrier estimate when documented drying scope, equipment days, monitoring, demolition, or unit pricing do not match the mitigation work performed or required. It amends the existing claim estimate — typically mitigation-only scope — rather than opening a new loss.",
    },
    {
      question: "How are water mitigation supplements different from reconstruction supplements?",
      answer:
        "Mitigation supplements address emergency services, extraction, drying, monitoring, and selective demolition through dry standard. Reconstruction supplements address rebuild scope — drywall, flooring, cabinets, paint — after mitigation ends. Carriers often separate these phases; mixing them without clear documentation slows approval.",
    },
    {
      question: "What line items are commonly missed on water mitigation estimates?",
      answer:
        "Equipment setup and daily rental, monitoring visits, moisture mapping, containment, floor and content protection, detach and reset for access, antimicrobial application when indicated, manipulation of contents, and extended drying days when the carrier stops at a template duration. General conditions and after-hours emergency lines are also frequent gaps.",
    },
    {
      question: "Why are drying days often underpaid on carrier estimates?",
      answer:
        "Carriers use average drying durations from desk templates that may not reflect Category 2 or 3 losses, dense assemblies, low evaporation environments, or hidden moisture in wall cavities. Without daily moisture logs proving progress toward dry standard, adjusters default to shorter equipment runs than field conditions require.",
    },
    {
      question: "What documentation do carriers require for mitigation supplements?",
      answer:
        "Labeled photos, moisture readings with meter type and location, dry logs or drying reports, equipment placement and runtime logs, site notes by room, invoices for specialty equipment or labor, and a revised estimate that mirrors the narrative. Documentation captured during drying beats post-job assembly.",
    },
    {
      question: "What are moisture logs and why do they matter?",
      answer:
        "Moisture logs record readings at defined points over time — often daily — showing moisture content or relative readings trending toward dry standard. They prove drying was necessary, equipment was justified, and demolition or rebuild should not start prematurely. Gaps in logging are a top reason drying extensions are denied.",
    },
    {
      question: "When should a water mitigation supplement be submitted?",
      answer:
        "Submit when you can document a gap between the carrier estimate and required mitigation scope — ideally while equipment is still on site and logs are current. Compare the estimate within the first 48 hours of receipt per your supplement SOP. Waiting until reconstruction begins often weakens mitigation-only arguments.",
    },
    {
      question: "Why are water supplements denied?",
      answer:
        "Denials cluster around incomplete dry logs, equipment days without readings, mitigation scope bundled with rebuild without separation, Category upgrades without supporting evidence, and antimicrobial or demolition lines without photos. Partial approvals are common — resubmit remaining lines with added evidence rather than resending the same package.",
    },
    {
      question: "How long should drying equipment run on a typical residential loss?",
      answer:
        "Duration depends on category of water, materials affected, equipment type, and environmental conditions — not a single national average. Residential losses often require several days to two weeks or more on complex assemblies. Carrier templates are starting points; your logs justify the actual timeline.",
    },
    {
      question: "How does Claims Ninja help mitigation contractors?",
      answer:
        "Claims Ninja supports mitigation and restoration contractors with estimate review, supplement packaging, carrier follow-up, and documentation coaching aligned to drying workflows. Performance-aligned fees tie cost to documented recovery so variable supplement labor scales with loss volume.",
    },
    {
      question: "Should mitigation and rebuild be on the same supplement?",
      answer:
        "They can be on related revisions, but carriers often approve mitigation first. Separate narratives and documentation packets when possible: dry logs and equipment for mitigation; finish schedules and rebuild scope for reconstruction. Clear phase boundaries improve approval speed on both.",
    },
  ],
  sections: [
    {
    ...
    {
      id: "why-water-claims-unique",
      heading: "Why water damage claims are unique",
      paragraphs: [
    ...
    {
      id: "mitigation-vs-roofing",
      heading: "How water mitigation claims differ from roofing claims",
      paragraphs: [
      ...
      links: [
        {
          label: "Roofing supplement playbook (contrast)",
          href: "/resources/blog/roofing-supplement-playbook",
        },
      ],
    },
    {
      id: "how-carriers-evaluate-water",
      heading: "How carriers evaluate water losses",
      paragraphs: [
      ...
      links: [
        { label: "Water damage claims solutions", href: "/solutions/water-damage" },
      ],
    },
    {
      id: "water-mitigation-process",
      heading: "The water mitigation process",
      paragraphs: [
    ...
    {
      id: "commonly-missed-mitigation-items",
      heading: "Commonly missed water mitigation line items",
      paragraphs: [
      ...
      callout: {
        title: "Commonly missed mitigation items",
        body: "Prioritize supplement evidence on equipment days, monitoring, moisture mapping, daily visits, containment, and detach and reset before fighting low-dollar consumables. Carriers approve extensions on logs more often than they approve unexplained PPE line increases.",
      },
    },
    {
      id: "equipment-line-items",
      heading: "Equipment",
      level: 3,
      paragraphs: [
    ...
    {
      id: "manipulation",
      heading: "Manipulation of contents",
      level: 3,
      paragraphs: [
    ...
    {
      id: "code-considerations",
      heading: "Code considerations",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Name files with claim number, room, and date. One wide photo and one close-up per key finding. Same-day moisture readings on every active drying day. When the estimate, dry log, and photo folder share the same room names, adjusters approve faster.",
      },
      links: [
        {
    ...
    },
    {
      ...
      heading: "Common reasons water supplements are denied",
      bullets: [
    ...
    {
      id: "mitigation-estimate-review",
      heading: "Water mitigation estimate review process",
      paragraphs: [
    ...
    {
      id: "identify-supplement-opportunities",
      heading: "How to identify supplement opportunities",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Review estimates within 48 hours, run the missed-items checklist on every water file, and capture daily logs before equipment comes down. One caught drying extension per week often exceeds the cost of a dedicated supplement reviewer on a busy mitigation book.",
      },
    },
    {
      id: "claims-ninja-mitigation",
      heading: "How Claims Ninja supports mitigation contractors",
      paragraphs: [
    ...
    {
      id: "ai-water-claim-review",
      heading: "AI-assisted water claim review",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use AI to prioritize which water files get deep review first — multi-room migration, Category 2 or 3, long equipment runs, or repeated carrier omission patterns — then apply this playbook and the Xactimate checklist before submission. Never send carrier supplements without human review.",
      },
      links: [
