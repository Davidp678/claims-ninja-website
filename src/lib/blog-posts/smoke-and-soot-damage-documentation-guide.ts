...
export const smokeAndSootDamageDocumentationGuide: BlogPost = {
  slug: "smoke-and-soot-damage-documentation-guide",
  title: "Smoke and Soot Damage Documentation Guide",
  excerpt:
  ...
  seoTitle: "Smoke and Soot Damage Documentation Guide",
  seoDescription:
  ...
  faq: [
    {
      question: "What is smoke damage documentation?",
      answer:
    ...
    {
      question: "What types of smoke damage require different cleaning documentation?",
      answer:
    ...
    {
      question: "How do carriers evaluate smoke migration claims?",
      answer:
    ...
    {
      question: "What photos prove soot contamination?",
      answer:
    ...
    {
      question: "How should HVAC smoke damage be documented?",
      answer:
    ...
    {
      question: "What are common smoke documentation mistakes?",
      answer:
    ...
    {
      question: "How does smoke documentation support supplements?",
      answer:
    ...
    {
      question: "What fixes smoke supplement denials?",
      answer:
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Why smoke and soot documentation matters",
      paragraphs: [
    ...
    {
      id: "smoke-vs-visible-fire-damage",
      heading: "How smoke damage differs from visible fire damage",
      paragraphs: [
    ...
    {
      id: "how-carriers-evaluate-smoke-docs",
      heading: "How carriers evaluate smoke damage documentation",
      paragraphs: [
    ...
    {
      id: "how-carriers-evaluate-soot-docs",
      heading: "How carriers evaluate soot contamination documentation",
      paragraphs: [
    ...
    {
      id: "types-of-smoke-damage",
      heading: "Types of smoke damage",
      paragraphs: [
    ...
    {
      id: "smoke-type-protein",
      heading: "Protein residue",
      level: 3,
      paragraphs: [
    ...
    {
      id: "smoke-type-fuel-oil",
      heading: "Fuel-oil residue",
      level: 3,
      paragraphs: [
    ...
    {
      id: "types-of-soot-contamination",
      heading: "Types of soot contamination",
      paragraphs: [
    ...
    {
      id: "how-smoke-travels",
      heading: "How smoke travels through structures",
      paragraphs: [
    ...
    {
      id: "how-soot-spreads",
      heading: "How soot spreads through structures",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Use claim number plus room label plus date in filenames. Capture wide context and substrate close-ups in every affected room. Same room names on photos, sketch, and estimate — adjusters approve indexed smoke files faster than chronological camera rolls.",
      },
    },
    {
      id: "doc-room-by-room-photos",
    ...
    {
      id: "doc-surface-documentation",
      heading: "Surface documentation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "doc-crawlspace",
      heading: "Crawlspace documentation",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "The costliest smoke documentation mistake is assuming the adjuster will infer hall and bedroom impact from kitchen photos alone. Walk migration paths; photograph every affected room; name them consistently before cleaning obscures evidence.",
      },
    },
    {
      id: "smoke-soot-and-supplements",
      heading: "How smoke and soot documentation support supplements",
      paragraphs: [
    ...
    {
      id: "smoke-soot-and-denial-recovery",
      heading: "How documentation supports denial recovery",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Warning signs of under-documented fire losses",
      bullets: [
    ...
    {
      id: "audit-readiness",
      heading: "Audit readiness on smoke and soot files",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Build smoke and soot files as if QA will open them before payment. Dated entries, consistent room names, HVAC report authorship, and pre-clean photos beat narrative assembled at invoice from technician memory.",
      },
    },
    {
      id: "identify-recovery-opportunities",
      ...
      callout: {
        ...
        body: "Review every fire estimate against a smoke migration room list before major cleaning. Photograph attics, crawlspaces, and upper halls on every kitchen fire — not only when the adjuster asks.",
      },
    },
    {
      id: "claims-ninja-smoke-soot-review",
      heading: "How Claims Ninja evaluates smoke and soot documentation",
      paragraphs: [
    ...
    {
      id: "ai-fire-documentation-review",
      heading: "AI-assisted fire documentation review",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Queue fire files where photo metadata room tags do not match estimate room list — fix naming before supplement submit. AI screening saves time; it does not replace attic walks, test cleans, or human sign-off on carrier packages.",
      },
      links: [
