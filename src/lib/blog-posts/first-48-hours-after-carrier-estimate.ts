...
export const first48HoursAfterCarrierEstimate: BlogPost = {
  slug: "first-48-hours-after-carrier-estimate",
  title: "The First 48 Hours After a Carrier Estimate",
  excerpt:
  ...
  seoTitle: "First 48 Hours After a Carrier Estimate for Contractors",
  seoDescription:
  ...
  faq: [
    {
      question: "What should contractors do first after receiving a carrier estimate?",
      answer:
    ...
    {
      question: "How quickly should carrier estimates be reviewed?",
      answer:
    ...
    {
      question: "What line items are commonly missed on carrier estimates?",
      answer:
    ...
    {
      question: "Should contractors begin work immediately after receiving an estimate?",
      answer:
    ...
    {
      question: "When should supplement opportunities be identified?",
      answer:
    ...
    {
      question: "What documentation should be gathered in the first 48 hours?",
      answer:
    ...
    {
      question: "What are signs of an under-scoped estimate?",
      answer:
    ...
    {
      question: "When should a supplementing partner be involved?",
      answer:
    ...
    {
      question: "How does AI estimate review help in the first 48 hours?",
      answer:
    ...
    {
      question: "What mistakes should contractors avoid in the first 48 hours?",
      answer:
    ...
    {
      question: "What if the carrier estimate arrives before we inspect the site?",
      answer:
  ...
  sections: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "One documented steep charge, drying extension, or code item caught in the first 48 hours often exceeds the labor cost of review on that file — and repeats across every similar loss in the same season.",
      },
    },
    {
      id: "what-carrier-estimate-represents",
      heading: "What a carrier estimate actually represents",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Common misconceptions contractors have",
      bullets: [
    ...
    {
      id: "risks-accepting-at-face-value",
      heading: "The risks of accepting an estimate at face value",
      paragraphs: [
    ...
    {
      id: "day-one-estimate-review",
      heading: "Day 1: Initial estimate review",
      paragraphs: [
    ...
    {
      id: "day-one-review-measurements",
      heading: "Review measurements",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-one-review-missing-lines",
      heading: "Review missing line items",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-one-review-code",
      heading: "Review code items",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-one-review-detach-reset",
      heading: "Review detach and reset opportunities",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-one-review-op",
      heading: "Review O&P considerations",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-one-documentation",
      heading: "Day 1: Documentation preparation",
      paragraphs: [
    ...
    {
      id: "day-two-validation",
      heading: "Day 2: Estimate validation",
      paragraphs: [
    ...
    {
      id: "day-two-compare-scope",
      heading: "Comparing estimate to actual scope",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-two-identify-supplements",
      heading: "Identifying supplement opportunities",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-two-organize-materials",
      heading: "Organizing support materials",
      level: 3,
      paragraphs: [
    ...
    {
      id: "day-two-prioritize-recovery",
      heading: "Prioritizing recovery opportunities",
      level: 3,
      paragraphs: [
    ...
    {
      id: "when-to-involve-partner",
      heading: "When to involve a supplementing partner",
      paragraphs: [
    ...
    {
      id: "common-mistakes-48-hours",
      heading: "Common mistakes made during the first 48 hours",
      bullets: [
      ...
      paragraphs: [
        "These mistakes drive supplement denials later. Fixing habits in the first 48 hours reduces load on the denial recovery workflow.",
    ...
    {
      id: "under-scoped-warning-signs",
      heading: "Warning signs of an under-scoped estimate",
      bullets: [
      ...
      callout: {
        title: "Under-scoped estimate warning signs",
        body: "If warning signs appear on a high-dollar file, escalate internal review the same day — not after the crew mobilizes. Under-scoped estimates rarely self-correct at final invoice.",
      },
    },
    {
      id: "claims-ninja-early-review",
      heading: "How Claims Ninja approaches early claim review",
      paragraphs: [
    ...
    {
      id: "ai-estimate-analysis",
      heading: "How AI-assisted estimate analysis will change the process",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use AI on Day 1 to sort files by recovery potential and denial risk — then apply human review and field documentation. Never mobilize production from raw AI output without estimator sign-off.",
      },
      links: [
    ...
    {
      id: "first-48-hour-checklist",
      heading: "First 48-hour checklist",
      bullets: [
