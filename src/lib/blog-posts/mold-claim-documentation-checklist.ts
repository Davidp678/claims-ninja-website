...
export const moldClaimDocumentationChecklist: BlogPost = {
  slug: "mold-claim-documentation-checklist",
  title:
  ...
  seoTitle: "Mold Claim Documentation Checklist for Contractors",
  seoDescription:
  ...
  sections: [
    ...
    {
      id: "why-checklists-improve-outcomes",
      heading: "Why Checklists Improve Claim Outcomes",
      paragraphs: [
    ...
    {
      id: "before-arriving-onsite",
      heading: "Before Arriving Onsite",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Moisture Source Documentation",
      paragraphs: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "How many photos should be taken during a mold claim?",
          href: "/faq#faq-mold-claim-photo-volume",
        },
        {
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "What documentation supports moisture mapping and containment on mold claims?",
          href: "/faq#faq-mold-moisture-containment-documentation-support",
        },
      ],
    },
    {
      id: "containment-documentation",
      heading: "Containment Documentation",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Equipment Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Should contractors document daily drying and remediation progress on mold claims?",
          href: "/faq#faq-mold-daily-progress-documentation-required",
        },
      ],
    },
    {
      id: "daily-documentation",
      heading: "Daily Documentation",
      paragraphs: [
    ...
    {
      id: "drying-remediation-progress",
      heading: "Drying and Remediation Progress",
      paragraphs: [
    ...
    {
      id: "prv-documentation",
      heading: "PRV Documentation",
      paragraphs: [
    ...
    {
      id: "final-documentation-package",
      heading: "Final Documentation Package",
      paragraphs: [
