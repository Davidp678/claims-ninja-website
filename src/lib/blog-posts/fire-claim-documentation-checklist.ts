...
export const fireClaimDocumentationChecklist: BlogPost = {
  ...
  seoTitle: "Fire Claim Documentation Checklist for Contractors",
  seoDescription:
  ...
  sections: [
    ...
    {
      id: "smoke-soot-documentation",
      heading: "Smoke & Soot Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Smoke & Soot Damage Documentation Guide (blog)",
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "Should contractors document hidden fire damage?",
    ...
    {
      id: "pack-out-documentation",
      heading: "Pack-Out Documentation",
      paragraphs: [
    ...
    {
      id: "code-upgrade-documentation",
      heading: "Code Upgrade Documentation",
      paragraphs: [
