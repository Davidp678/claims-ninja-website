...
export const moldDocumentationMistakes: BlogPost = {
  slug: "mold-documentation-mistakes",
  title:
  ...
  seoTitle:
    "10 Mold Documentation Mistakes That Cost Contractors Money on Claims",
  seoDescription:
  ...
  sections: [
    ...
    {
      id: "mistake-1-moisture-source",
      heading: "Mistake #1: Failing to Document the Moisture Source",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What are the most common mold documentation mistakes?",
          href: "/faq#faq-mold-common-documentation-mistakes",
        },
      ],
    },
    {
      id: "mistake-2-poor-photo-documentation",
      heading: "Mistake #2: Poor Photo Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-3-skipping-moisture-readings",
      heading: "Mistake #3: Skipping Moisture Readings",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why are moisture readings important on mold claims?",
          href: "/faq#faq-mold-moisture-readings-why-important",
        },
        {
    ...
    {
      id: "mistake-4-ignoring-hidden-mold",
      heading: "Mistake #4: Ignoring Hidden Mold",
      paragraphs: [
    ...
    {
      id: "mistake-5-weak-remediation-documentation",
      heading: "Mistake #5: Weak Remediation Documentation",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Mistake #6: No Post-Remediation Verification Documentation",
      paragraphs: [
    ...
    {
      id: "mistake-7-ignoring-mold-protocol",
      heading: "Mistake #7: Ignoring the Mold Protocol",
      paragraphs: [
    ...
    {
      id: "mistake-8-disorganized-commercial-documentation",
      heading: "Mistake #8: Disorganized Commercial Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contractors organize mold claim documentation?",
          href: "/faq#faq-mold-claim-documentation-organization",
        },
        {
    ...
    {
      id: "mistake-9-weak-estimate-narratives",
      heading: "Mistake #9: Weak Estimate Narratives",
      paragraphs: [
    ...
    {
      id: "mistake-10-submitting-too-early",
      heading: "Mistake #10: Submitting Documentation Too Early",
      paragraphs: [
