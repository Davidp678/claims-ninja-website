...
export const xactimateEstimateReviewChecklistContractors: BlogPost = {
  slug: "xactimate-estimate-review-checklist-contractors",
  title: "Xactimate Estimate Review Checklist for Contractors",
  excerpt:
  ...
  seoTitle: "Xactimate Estimate Review Checklist for Contractors",
  seoDescription:
  ...
  faq: [
    ...
    {
      question: "Can Xactimate estimates be challenged?",
      answer:
    ...
    {
      question: "Why are line items missed on carrier estimates?",
      answer:
    ...
    {
      question: "Does Xactimate determine pricing?",
      answer:
    ...
    {
      question: "How often are insurance estimates under-scoped?",
      answer:
    ...
    {
      question: "What documentation helps estimate reviews?",
      answer:
    ...
    {
      question: "What should contractors check first on a carrier estimate?",
      answer:
    ...
    {
      question: "How long should an estimate review take?",
      answer:
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Why estimate reviews matter for contractors",
      paragraphs: [
    ...
    {
      id: "what-is-xactimate",
      heading: "What is Xactimate?",
      paragraphs: [
    ...
    {
      id: "how-carriers-use-xactimate",
      heading: "How carriers use Xactimate",
      paragraphs: [
    ...
    {
      id: "why-estimates-miss-revenue",
      heading: "Why carrier estimates still miss revenue opportunities",
      paragraphs: [
      ...
      callout: {
        ...
        body: "The highest-ROI review window is the first 48 hours after estimate receipt. Compare sketch dimensions to your measurement report, verify general conditions, then walk trade-specific accessories. One caught steep charge or drying extension on a busy storm season pays for the process across dozens of files.",
      },
      links: [
        {
    ...
    {
      id: "contractor-review-process",
      heading: "The contractor estimate review process",
      paragraphs: [
    ...
    },
    {
      ...
      heading: "Contractor estimate review checklist",
      paragraphs: [
    ...
    {
      id: "check-roof-measurements",
      heading: "Review roof measurements",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-waste-factors",
      heading: "Review waste factors",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-steep-high",
      heading: "Review steep and high charges",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-ventilation",
      heading: "Review ventilation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-detach-reset",
      heading: "Review detach and reset items",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-code-items",
      heading: "Review code-driven items",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-labor-assumptions",
      heading: "Review labor assumptions",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-material-pricing",
      heading: "Review material pricing",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-op-eligibility",
      heading: "Review overhead and profit eligibility",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-temporary-protection",
      heading: "Review temporary protection",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-interior-damages",
      heading: "Review interior damages",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-ancillary-structures",
      heading: "Review ancillary structures",
      level: 3,
      paragraphs: [
    ...
    {
      id: "check-documentation-quality",
      heading: "Review documentation quality",
      level: 3,
      paragraphs: [
      ...
      callout: {
        ...
        body: "Label photos by room and date. Capture pre-mitigation and post-mitigation moisture readings on water jobs. When your estimate mirrors the story in the photos, approval rates climb — even on strict carriers.",
      },
      links: [
        {
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Steep and high charges, drip edge, starter, ridge cap, and extended drying are the highest-frequency roofing and restoration misses — not exotic line items. Scan those five on every file before deep-diving obscure trades.",
      },
    },
    {
      id: "red-flags-in-carrier-estimates",
      heading: "Red flags inside carrier estimates",
      bullets: [
    ...
    {
      id: "claims-ninja-estimate-reviews",
      heading: "How Claims Ninja approaches estimate reviews",
      paragraphs: [
    ...
    {
      id: "ai-assisted-estimate-reviews",
      heading: "How AI-assisted estimate reviews will change the industry",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use AI to catch structural gaps early — scope completeness, quantity mismatches, and repetitive carrier omissions — then apply human expertise to code, policy, and client communication. Never submit machine output without estimator review.",
      },
      links: [
    ...
    {
      id: "final-checklist-summary",
      heading: "Final checklist summary",
      paragraphs: [
      ...
      links: [
        {
          label: "Complete supplementing guide",
          href: "/resources/blog/insurance-supplementing-guide-contractors",
        },
      ],
    },
