...
export const moistureMappingMistakesThatCostContractorsMoney: BlogPost = {
  slug: "moisture-mapping-mistakes-that-cost-contractors-money",
  title: "Moisture Mapping Mistakes That Cost Contractors Money",
  excerpt:
  ...
  seoTitle: "Moisture Mapping Mistakes That Cost Contractors Money",
  seoDescription:
  ...
  faq: [
    {
      question: "What moisture mapping mistakes cost contractors the most money?",
      answer:
    ...
    {
      question: "Can missing unaffected-area readings cause claim reductions?",
      answer:
    ...
    {
      question: "How do carriers use moisture maps during desk review?",
      answer:
    ...
    {
      question: "Do weak moisture maps cause drying-day reductions?",
      answer:
    ...
    {
      question: "Can moisture maps support supplement recovery after initial underpayment?",
      answer:
    ...
    {
      question: "What is the difference between a moisture map and a dry log?",
      answer:
    ...
    {
      question: "Are photos enough without a moisture map?",
      answer:
    ...
    {
      question: "How does incomplete room documentation affect equipment billing?",
      answer:
    ...
    {
      question: "When should moisture maps be updated during a job?",
      answer:
    ...
    {
      question: "How does Claims Ninja help when mapping documentation is challenged?",
      answer:
    ...
    {
      question: "How do moisture mapping mistakes affect Category 3 claims?",
      answer:
  ...
  sections: [
    ...
    {
      id: "what-is-a-moisture-map",
      heading: "What a moisture map is",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What should a moisture map include?",
          href: "/faq#faq-water-moisture-map-contents",
        },
      ],
    },
    {
      id: "why-moisture-maps-matter",
      heading: "Why moisture maps matter in water claims",
      paragraphs: [
    ...
    {
      id: "common-moisture-mapping-mistakes",
      heading: "The most common moisture mapping mistakes",
      paragraphs: [
      ...
      callout: {
        title: "Revenue impact categories",
        body: "Weak moisture mapping predictably hits mapping line items, room count on sketch, drying-day duration, dehumidifier and air mover count, monitoring visit approval, and supplement success rate — often as partial underpayment, not formal denial.",
      },
      links: [
        {
          label: "Moisture mapping best practices",
    ...
    {
      id: "missing-affected-area-readings",
      heading: "Missing affected-area readings",
      paragraphs: [
    ...
    {
      id: "missing-unaffected-area-readings",
      heading: "Missing unaffected-area readings",
      paragraphs: [
    ...
    {
      id: "incomplete-room-documentation",
      heading: "Incomplete room documentation",
      paragraphs: [
      ...
      callout: {
        ...
        body: "One room name list per job — shared by map, dry log, photos, and estimate — uploaded to the claim file before end of day one. Variation by tech or software export is a preventable revenue leak.",
      },
      links: [
        {
    ...
    {
      id: "lack-of-progression-tracking",
      heading: "Lack of progression tracking",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "When are moisture logs required?",
          href: "/faq#faq-documentation-moisture-logs",
        },
      ],
    },
    {
      id: "missing-daily-updates",
      heading: "Missing daily updates",
      paragraphs: [
    ...
    {
      id: "poor-photo-integration",
      heading: "Poor photo integration",
      paragraphs: [
    ...
    {
      id: "how-carriers-use-moisture-maps",
      heading: "How carriers use moisture maps during review",
      paragraphs: [
    ...
    {
      id: "revenue-impact-of-weak-mapping",
      heading: "Revenue impact of weak moisture mapping",
      paragraphs: [
      ...
      callout: {
        title: "Margin leak",
        body: "A $400 mapping line denial plus two cut drying days plus one reduced dehumidifier on a single residential file can exceed $1,500 — repeated across storm volume, that is operational margin, not adjuster personality.",
      },
      links: [
        {
    ...
    {
      id: "moisture-maps-and-supplement-recovery",
      heading: "Moisture maps and supplement recovery",
      paragraphs: [
    ...
    {
      id: "building-defensible-documentation-package",
    ...
    {
      id: "claims-ninja-moisture-mapping-support",
      heading: "How Claims Ninja supports moisture mapping claim recovery",
      paragraphs: [
