...
export const fireDamageClaimDocumentationGuide: BlogPost = {
  slug: "fire-damage-claim-documentation-guide",
  title: "Fire Damage Claim Documentation Guide",
  excerpt:
    "Fire damage claim documentation for contractors: photos, soot and smoke evidence, contents inventories, structural scope, HVAC and code support, supplements, denial recovery, and restoration workflows.",
  ...
  seoTitle: "Fire Damage Claim Documentation Guide",
  seoDescription:
  ...
  faq: [
    {
      question: "What should be documented on a fire damage insurance claim?",
      answer:
        "Document room-by-room photos, soot and smoke extent, odor conditions, structural damage, contents inventories, HVAC impact, demolition justification, measurements, third-party reports when used, and invoices tied to line items. Align room names across photos, sketch, and estimate.",
    },
    {
      question: "How is soot documentation different from smoke documentation?",
      answer:
        "Soot documentation focuses on visible particulate residue on surfaces — color, texture, location, and cleaning versus replacement decisions. Smoke documentation addresses vapor and particulate migration beyond the fire room — staining, corrosion risk, and hidden cavities. Both need labeled photos and narrative tied to affected materials.",
    },
    {
      question: "Why are fire claims more documentation-intensive than water claims?",
      answer:
        "Fire losses affect multiple surfaces, contents, and systems simultaneously — soot, smoke, odor, structure, and HVAC — with scope that expands during demolition. Water claims center on time-phased drying evidence; fire claims center on spatial contamination and rebuild scope proof.",
    },
    {
      question: "What contents documentation do carriers expect?",
      answer:
        "Carriers expect room-located inventories with description, quantity, condition, salvageability, and photos for high-value items. Pack-out and storage documentation should tie to inventory lines. Missing contents proof is a top reason contents cleaning and replacement lines reduce.",
    },
    {
      question: "How do photos support fire damage supplements?",
      answer:
        "Photos prove pre-demolition conditions, hidden damage discovered during tear-out, smoke migration into unaffected-looking rooms, matching requirements, and completed procedures. Indexed photos in the supplement cover letter map evidence to line numbers adjusters can forward.",
    },
    {
      question: "When should fire damage supplements be submitted?",
      answer:
        "Submit when documented scope exceeds the carrier estimate and you have evidence — often after initial scope review, after demolition discovery, or when specialty reports return. Early submission on visible gaps beats invoice-only fights; pair with the insurance supplementing guide for process timing.",
    },
    {
      question: "What documentation fixes fire supplement denials?",
      answer:
        "Targeted resubmission: labeled photos for denied rooms, inventory pages for contents lines, HVAC inspection excerpts for duct lines, code citations with permit support, and cover letter quoting denial language with attachment names. Follow the supplement denial recovery guide for workflow.",
    },
    {
      question: "Should HVAC cleaning be documented separately on fire claims?",
      answer:
        "Yes. HVAC scope needs duct inspection reports, photos at registers and equipment, narrative on why system cleaning or replacement is necessary, and line items separated from general smoke wipe. Undocumented HVAC claims often reduce on desk review.",
    },
    {
      question: "How long should fire claim documentation be retained?",
      answer:
        "Retain photos, inventories, reports, and estimates with the file for contract, warranty, and state record requirements — often years after final payment. Rebuild disputes and audits can arrive after occupancy.",
    },
    {
      question: "How does code documentation work on fire rebuilds?",
      answer:
        "Cite jurisdiction, code edition, and section when upgrades are required at repair. Support with permit applications, inspector comments, or manufacturer requirements triggered by extent of damage — not generic code dumps without triggered work.",
    },
    {
      question: "How does Claims Ninja help with fire claim documentation?",
      answer:
        "Claims Ninja reviews carrier estimates against photo sets, inventories, and scope narratives; identifies supplement gaps; organizes carrier packages; and supports denial recovery with performance-aligned fees tied to documented increases.",
    },
  ],
  sections: [
    {
    ...
    {
      id: "why-fire-documentation-intensive",
      heading: "Why fire claims are documentation-intensive",
      paragraphs: [
    ...
    {
      id: "how-fire-differs-from-water",
      heading: "How fire claims differ from water claims",
      paragraphs: [
    ...
    {
      id: "how-carriers-evaluate",
      heading: "How carriers evaluate fire damage documentation",
      paragraphs: [
    ...
    {
      id: "core-documentation-requirements",
      heading: "Core fire claim documentation requirements",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Use one room naming convention across photos, inventory, sketch, and estimate — claim number plus room label plus date in filenames. The fire file should read as one story, not three dialects.",
      },
    },
    {
      id: "core-documentation-audit-readiness",
      heading: "Audit readiness on fire files",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Assume large-loss and commercial fire files face audit. Contemporaneous photos, dated inventories, and report authorship matter more than polished cover letters attached to thin field proof.",
      },
    },
    {
      id: "core-photos",
    ...
    {
      id: "core-room-by-room",
      heading: "Room-by-room documentation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "core-contents",
      heading: "Contents documentation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "specialized-considerations",
      heading: "Specialized fire claim considerations",
      paragraphs: [
    ...
    {
      id: "special-smoke-migration",
      heading: "Smoke migration",
      level: 3,
      paragraphs: [
    ...
    {
      id: "special-contents-cleaning",
      heading: "Contents cleaning",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "The costliest fire documentation mistake is assuming the adjuster will infer smoke in the hall from photos of the kitchen only. Walk the loss; photograph migration; name rooms consistently.",
      },
      links: [
        {
    ...
    {
      id: "documentation-and-supplements",
      heading: "How documentation impacts supplements",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Audit five recent fire supplements: list lines approved versus denied and trace each denial to a documentation gap — missing room, thin inventory, no HVAC report. Fix the template, not only the negotiator.",
      },
      links: [
        {
          label: "Complete insurance supplementing guide",
    ...
    {
      id: "documentation-and-denial-recovery",
      heading: "How documentation impacts denial recovery",
      paragraphs: [
    ...
    {
      id: "warning-signs-under-supported",
      heading: "Warning signs of under-supported fire claims",
      bullets: [
    ...
    {
      id: "claims-ninja-fire-documentation",
      heading: "How Claims Ninja evaluates fire claim documentation",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Queue fire files where photo metadata room tags do not match estimate room list — fix naming before supplement submit. AI screening saves time; it does not replace field capture.",
      },
      links: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "This guide is the first article in the Fire Damage Claims cluster — the authority base for future fire playbooks and trade-specific recovery resources on Claims Ninja.",
      ],
      links: [
        {
          label: "Complete insurance supplementing guide",
