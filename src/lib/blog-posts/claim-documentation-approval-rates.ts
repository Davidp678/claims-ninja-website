  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "On fire and smoke losses, room-by-room photos, soot and smoke proof, contents inventories, and HVAC documentation are the approval equation — see the fire damage claim documentation guide for field standards and the fire damage supplement playbook for line items and supplement workflow.",
      ],
      links: [
        {
