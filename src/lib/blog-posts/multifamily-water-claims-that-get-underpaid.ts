...
export const multifamilyWaterClaimsThatGetUnderpaid: BlogPost = {
  slug: "multifamily-water-claims-that-get-underpaid",
  title: "Multifamily Water Claims That Get Underpaid",
  excerpt:
  ...
  seoTitle: "Multifamily Water Claims That Get Underpaid",
  seoDescription:
    "Learn why multifamily water claims get underpaid, including unit tracking failures, common area omissions, equipment reductions, drying day disputes, tenant impact gaps, and weak documentation packages.",
  relatedPostSlugs: [
  ...
  sections: [
    {
      ...
      links: [
        ...
        {
          label: "Why do multifamily water claims get underpaid?",
          href: "/faq#faq-water-multifamily-claims-underpaid",
        },
        {
    ...
    {
      id: "why-multifamily-water-claims-are-commonly-underpaid",
      heading: "Why Multifamily Water Claims Are Commonly Underpaid",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why are apartment water mitigation claims frequently disputed?",
          href: "/faq#faq-water-apartment-mitigation-claims-disputed",
        },
      ],
    },
    {
      id: "underpayment-cause-1-missing-unit-by-unit-documentation",
      heading: "Underpayment Cause #1: Missing Unit-by-Unit Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should contractors document affected units in multifamily water claims?",
          href: "/faq#faq-water-multifamily-units-documentation",
        },
      ],
    },
    {
      id: "underpayment-cause-2-common-area-scope-gets-omitted",
      heading: "Underpayment Cause #2: Common Area Scope Gets Omitted",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Should common areas be documented separately on commercial water losses?",
    ...
    {
      id: "underpayment-cause-3-equipment-charges-get-reduced",
      heading: "Underpayment Cause #3: Equipment Charges Get Reduced",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Why do carriers reduce equipment charges on multifamily water losses?",
          href: "/faq#faq-water-multifamily-equipment-reductions",
        },
        {
          label: "What documentation supports equipment usage in apartment water losses?",
          href: "/faq#faq-water-apartment-equipment-usage-documentation",
        },
      ],
    },
    {
      id: "underpayment-cause-4-drying-days-get-cut",
      heading: "Underpayment Cause #4: Drying Days Get Cut",
      paragraphs: [
      ...
      links: [
        {
          label: "Daily monitoring checklist",
    ...
    {
      id: "underpayment-cause-5-tenant-impact-is-not-documented",
      heading: "Underpayment Cause #5: Tenant Impact Is Not Documented",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Should tenant impact be documented on multifamily water claims?",
          href: "/faq#faq-water-multifamily-tenant-impact-documentation",
        },
        {
    ...
    {
      id: "underpayment-cause-6-moisture-migration-is-not-proven",
      heading: "Underpayment Cause #6: Moisture Migration Is Not Proven",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How should multifamily water damage be documented?",
          href: "/faq#faq-water-multifamily-loss-documentation",
        },
      ],
    },
    {
      id: "underpayment-cause-7-invoice-does-not-match-documentation",
      heading: "Underpayment Cause #7: The Invoice Does Not Match the Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Should commercial documentation match the mitigation invoice?",
          href: "/faq#faq-water-commercial-documentation-invoice-match",
        },
        {
          label: "How can contractors support full payment on multifamily water claims?",
          href: "/faq#faq-water-multifamily-full-payment-support",
        },
      ],
    },
    {
      id: "underpayment-cause-8-large-loss-complexity-not-organized",
      heading: "Underpayment Cause #8: Large-Loss Complexity Is Not Organized Clearly",
      paragraphs: [
      ...
      links: [
        ...
        },
        {
          ...
          href: "/faq#faq-water-large-loss-qualifies",
        },
      ],
    },
    {
      id: "how-contractors-can-reduce-multifamily-underpayment",
      heading: "How Contractors Can Reduce Multifamily Water Claim Underpayment",
      paragraphs: [
    ...
    {
      id: "multifamily-water-claim-documentation-checklist",
      heading: "Multifamily Water Claim Documentation Checklist",
      paragraphs: [
