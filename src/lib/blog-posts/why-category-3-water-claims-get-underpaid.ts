...
export const whyCategory3WaterClaimsGetUnderpaid: BlogPost = {
  slug: "why-category-3-water-claims-get-underpaid",
  title: "Why Category 3 Water Claims Get Underpaid",
  excerpt:
  ...
  seoTitle: "Why Category 3 Water Claims Get Underpaid",
  seoDescription:
    "Why Category 3 water claims get underpaid: carrier invoice reductions, documentation gaps on contaminated losses, equipment and containment cuts, disposal disputes, and supplement recovery for contractors.",
  relatedPostSlugs: [
  ...
  faq: [
    {
      question: "Why are Category 3 water claims underpaid more often than Category 1 or 2?",
      answer:
    ...
    {
      question: "What is the most common reason Category 3 invoices get reduced?",
      answer:
    ...
    {
      question: "Do carriers deny Category 3 classification or just cut related line items?",
      answer:
    ...
    {
      question: "How do moisture maps affect Category 3 payment?",
      answer:
    ...
    {
      question: "Why do carriers cut containment and HEPA on Category 3 jobs?",
      answer:
    ...
    {
      question: "How are disposal charges disputed on Category 3 claims?",
      answer:
    ...
    {
      question: "Can dry logs recover underpaid Category 3 drying days?",
      answer:
    ...
    {
      question: "When should I supplement a Category 3 water claim?",
      answer:
    ...
    {
      question: "What does carrier desk review look for on Category 3 files?",
      answer:
    ...
    {
      question: "How does missing daily monitoring documentation cause underpayment?",
      answer:
    ...
    {
      question: "What recovery steps work on underpaid Category 3 invoices?",
      answer:
    ...
    {
      question: "How does Claims Ninja help with Category 3 claim recovery?",
      answer:
  ...
  sections: [
    ...
    {
      id: "why-carriers-reduce-category-3-invoices",
      heading: "Why carriers reduce Category 3 invoices",
      paragraphs: [
      ...
      callout: {
        title: "Reduction pattern",
        body: "Category 3 reductions usually attack lines that cost the most and document the least — disposal, extended equipment days, containment setup, HEPA runtime, and monitoring visits billed without same-day log entries.",
      },
      links: [
        {
          label: "Category 3 water damage documentation guide",
    ...
    {
      id: "documentation-failures-that-trigger-reductions",
      heading: "Documentation failures that trigger reductions",
      paragraphs: [
      ...
      callout: {
        ...
        body: "Treat Category 3 files as audit-ready from hour one: classification notes, map, day-one photos, and dry log entry before the crew leaves site — not as documentation you will assemble if the adjuster pushes back.",
      },
      links: [
        {
    ...
    {
      id: "missing-moisture-maps",
      heading: "Missing moisture maps",
      paragraphs: [
    ...
    {
      id: "equipment-charge-reductions",
      heading: "Equipment charge reductions",
      paragraphs: [
    ...
    {
      id: "containment-reductions",
      heading: "Containment reductions",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "What documentation supports containment charges?",
          href: "/faq#faq-water-containment-documentation",
        },
      ],
    },
    {
      id: "hepa-filtration-reductions",
      heading: "HEPA filtration reductions",
      paragraphs: [
      ...
      links: [
        {
          label: "What documentation supports HEPA filtration charges?",
          href: "/faq#faq-water-hepa-filtration-documentation",
        },
        {
    ...
    {
      id: "disposal-disputes",
      heading: "Disposal disputes",
      paragraphs: [
      ...
      callout: {
        title: "Disposal proof",
        body: "Before-and-after demolition photos with room labels, material type in notes, and haul receipt for large volumes — submitted with the initial invoice, not after disposal lines are cut.",
      },
      links: [
        {
          label: "Category 3 water damage documentation guide",
        ...
        {
          label: "What qualifies as Category 3 water?",
          href: "/faq#faq-water-category-3-qualifies",
        },
      ],
    },
    {
      id: "missing-daily-monitoring-documentation",
      heading: "Missing daily monitoring documentation",
      paragraphs: [
    ...
    {
      id: "carrier-review-behavior",
      heading: "Carrier review behavior",
      paragraphs: [
      ...
      links: [
        {
          label: "Why are Category 3 mitigation invoices reduced?",
    ...
    },
    {
      ...
      callout: {
        ...
        body: "On your last three Category 3 underpayments, sum dollars cut on disposal, equipment days, HEPA, and monitoring. The largest bucket tells you which SOP to fix first — usually logs, maps, or intake classification.",
      },
      links: [
        {
    ...
    },
    {
      ...
      heading: "When supplementing becomes necessary",
      paragraphs: [
    ...
    {
      id: "claims-ninja-category-3-support",
      heading: "How Claims Ninja supports Category 3 claim recovery",
      paragraphs: [
