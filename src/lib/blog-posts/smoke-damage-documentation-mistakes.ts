...
export const smokeDamageDocumentationMistakes: BlogPost = {
  slug: "smoke-damage-documentation-mistakes",
  title:
  ...
  sections: [
    ...
    {
      id: "mistake-1-treating-smoke-as-cosmetic",
      heading: "Mistake #1: Treating Smoke Damage as Cosmetic",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Can smoke damage exist without visible soot?",
          href: "/faq#faq-smoke-damage-invisible-without-soot",
        },
        {
          label: "When should smoke-damaged materials be replaced instead of cleaned?",
          href: "/faq#faq-smoke-damage-clean-vs-replace",
        },
      ],
    },
    {
      id: "mistake-2-failing-to-document-odor",
      heading: "Mistake #2: Failing to Document Odor Conditions",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Odor Documentation Procedure",
          href: "/resources/guides/fire-damage/odor-documentation-guide",
        },
        {
          label: "How should odor be documented on fire claims?",
          href: "/faq#faq-fire-odor-deodorization",
        },
      ],
    },
    {
      id: "mistake-3-incomplete-room-photography",
      heading: "Mistake #3: Incomplete Room-by-Room Photography",
      paragraphs: [
      ...
      links: [
        {
          label: "What photos should be taken for smoke damage claims?",
          href: "/faq#faq-smoke-damage-claim-photos-required",
        },
        {
    ...
    {
      id: "mistake-4-ignoring-hvac-contamination",
      heading: "Mistake #4: Ignoring HVAC Contamination",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "Does smoke damage require HVAC documentation?",
          href: "/faq#faq-smoke-damage-hvac-documentation-required",
        },
      ],
    },
    {
      id: "mistake-5-missing-concealed-areas",
      heading: "Mistake #5: Missing Attics, Crawlspaces, and Concealed Areas",
      paragraphs: [
    ...
    {
      id: "mistake-6-poor-contents-documentation",
      heading: "Mistake #6: Poor Contents Documentation",
      paragraphs: [
      ...
      links: [
        ...
        {
          label: "How do contractors document smoke-damaged personal property?",
          href: "/faq#faq-contents-smoke-damage-documentation",
        },
        {
    ...
    {
      id: "mistake-7-cleaning-vs-replacement",
      heading: "Mistake #7: Failing to Separate Cleaning from Replacement",
      paragraphs: [
    ...
    {
      id: "mistake-8-weak-photo-organization",
      heading: "Mistake #8: Weak Photo Organization",
      paragraphs: [
    ...
    {
      id: "mistake-9-code-related-smoke-repairs",
      heading: "Mistake #9: Ignoring Code-Related Smoke Repairs",
      paragraphs: [
        "Smoke documentation often stops at cleanable surfaces — while code-driven repairs discovered during demolition go unphotographed and unbilled. Fire separation assemblies, damaged drywall requiring full replacement under current code, insulation upgrades, and mechanical system corrections are legitimate scope on many rebuilds — but only when permit and inspection evidence supports them.",
        "Fire separation and rated assemblies frequently require upgrade when opened during smoke remediation or rebuild. Document which walls were opened, what the AHJ or plan reviewer required, and inspection sign-offs before closure. Drywall replacement scope tied to code citations outperforms generic smoke seal lines on non-compliant assemblies.",
        "Insulation replacement in smoke-affected cavities often triggers current energy and fire-blocking requirements. Mechanical systems disturbed during cleaning may require code-compliant reinstallation — not only restoration to pre-loss condition. Photograph non-compliant conditions at demo; attach permit applications and correction notices to the file.",
        "Code-required repairs intersect with smoke scope when the same demolition exposes both contamination and non-compliant construction. Index code upgrade documentation separately from smoke cleaning folders so desk reviewers can evaluate each line group — ordinance and law coverage varies by policy, but documentation gaps guarantee denial regardless of endorsement.",
      ],
      bullets: [
        "Fire separation — rated assembly photos and AHJ requirements at demo",
        "Drywall replacement — full assembly removal when code requires, not spot repair",
        "Insulation — cavity condition and current code upgrade requirements",
        "Mechanical systems — code-compliant reinstallation beyond cleaning scope",
        "Permit evidence — applications, correction notices, and inspection sign-offs",
      ],
      links: [
        {
        ...
        {
          label: "How do contractors document required code upgrades?",
          href: "/faq#faq-fire-code-upgrade-contractor-documentation",
        },
      ],
    },
    {
      id: "mistake-10-no-narrative",
      heading: "Mistake #10: Submitting Documentation Without a Narrative",
      paragraphs: [
      ...
      links: [
        ...
        },
        {
          ...
          href: "/faq#faq-fire-supplement-contractor-documentation",
        },
        {
          label: "Why do smoke damage insurance claims get underpaid?",
          href: "/faq#faq-smoke-damage-claims-underpaid-why",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: "Fire damage guides hub",
          href: "/resources/guides/fire-damage",
        },
        {
          label: "Smoke & Soot Damage Documentation Guide",
          href: "/resources/guides/fire-damage/smoke-soot-damage-documentation-guide",
        ...
        {
          label: "How do contractors document smoke damage for insurance claims?",
          href: "/faq#faq-smoke-damage-contractor-documentation-insurance",
        },
