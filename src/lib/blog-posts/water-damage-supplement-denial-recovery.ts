...
export const waterDamageSupplementDenialRecovery: BlogPost = {
  slug: "water-damage-supplement-denial-recovery",
  title: "Water Damage Supplement Denial Recovery",
  excerpt:
  ...
  seoTitle: "Water Damage Supplement Denial Recovery",
  seoDescription:
  ...
  faq: [
    {
      question: "Why are water mitigation supplements denied?",
      answer:
    ...
    {
      question: "Can a denied water damage supplement be resubmitted?",
      answer:
    ...
    {
      question: "What is the difference between denial and underpayment?",
      answer:
    ...
    {
      question: "How should I handle partial denial on drying lines?",
      answer:
    ...
    {
      question: "When should I request a re-inspection on a water loss?",
      answer:
    ...
    {
      question: "How long should I wait before resubmitting a denied water supplement?",
      answer:
    ...
    {
      question: "What documentation fixes drying day denials?",
      answer:
    ...
    {
      question: "What if monitoring visits were denied?",
      answer:
    ...
    {
      question: "Should mitigation and rebuild denials be fought together?",
      answer:
    ...
    {
      question: "How does Claims Ninja help with denied water supplements?",
      answer:
    ...
    {
      question: "Can AI help with water supplement denial recovery?",
      answer:
  ...
  sections: [
    ...
    {
      id: "why-water-supplements-denied",
      heading: "Why water damage supplements get denied",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "On partial denials, resubmit denied lines only with a cover letter table: line number, denial reason quoted, new evidence file name. Carriers approve focused water mitigation resubmissions faster than repeated full supplements.",
      },
    },
    {
      ...
      callout: {
        ...
        body: "On water files, drying duration denials almost always trace to dry log gaps or map-to-sketch mismatches — not exotic policy exclusions. Read the denial letter for which bucket applies before writing a response.",
      },
    },
    {
      id: "denial-missing-dry-logs",
    ...
    {
      id: "denial-incomplete-photos",
      heading: "Incomplete photos",
      level: 3,
      paragraphs: [
    ...
    {
      id: "denial-insufficient-monitoring",
      heading: "Insufficient monitoring documentation",
      level: 3,
      paragraphs: [
    ...
    {
      id: "denial-equipment-disputes",
      heading: "Equipment charge disputes",
      level: 3,
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        title: "Recovery opportunities",
        body: "One strong resubmission beats three weak ones. Carriers track contractors who resend identical supplements — the next file gets harder review.",
      },
    },
    {
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Use map point IDs in dry log rows and photo index entries — reviewers connect trend lines to locations in one pass. Inconsistent room names are a silent resubmission killer.",
      },
    },
    {
      id: "doc-strategy-dry-logs",
      heading: "Dry logs",
      level: 3,
      paragraphs: [
    ...
    {
      id: "doc-strategy-equipment",
      heading: "Equipment records",
      level: 3,
      paragraphs: [
    ...
    {
      id: "claims-ninja-water-denial",
      heading: "How Claims Ninja approaches water damage denial recovery",
      paragraphs: [
    ...
    },
    {
      ...
      callout: {
        ...
        body: "Use AI to preflight resubmissions: log days versus billed equipment days, monitoring visits versus log entries, map rooms versus sketch rooms — then fix gaps before the adjuster sees the second package.",
      },
      links: [
