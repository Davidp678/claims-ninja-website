...
export const equipmentChargesThatGetCutFromWaterClaims: BlogPost = {
  slug: "equipment-charges-that-get-cut-from-water-claims",
  title:
  ...
  seoTitle:
    "Equipment Charges That Get Cut From Water Claims | Contractor Recovery Guide",
  seoDescription:
  ...
  faq: [
    {
      question: "Why do insurance carriers reduce equipment charges on water claims?",
      answer:
    ...
    {
      question: "What is the most common reason air mover charges get cut?",
      answer:
    ...
    {
      question: "How do dehumidifier reductions differ from air mover cuts?",
      answer:
    ...
    {
      question: "When are HEPA and air scrubber lines reduced?",
      answer:
    ...
    {
      question: "Can missing daily monitoring records cause equipment cuts?",
      answer:
    ...
    {
      question: "How should contractors recover cut equipment charges?",
      answer:
    ...
    {
      question: "Does equipment removal timing affect payment?",
      answer:
    ...
    {
      question: "What documentation package supports equipment recovery?",
      answer:
    ...
    {
      question: "When should I supplement for reduced equipment charges?",
      answer:
    ...
    {
      question: "How does Claims Ninja help with equipment charge recovery?",
      answer:
  ...
  sections: [
    ...
    {
      id: "why-equipment-charges-are-frequently-reduced",
      heading: "Why Equipment Charges Are Frequently Reduced",
      paragraphs: [
      ...
      links: [
        {
          label: "Why do insurance carriers reduce equipment charges?",
    ...
    {
      id: "how-carriers-evaluate-equipment-usage",
      heading: "How Carriers Evaluate Equipment Usage",
      paragraphs: [
    ...
    {
      id: "air-mover-charge-reductions",
      heading: "Air Mover Charge Reductions",
      paragraphs: [
      ...
      links: [
        {
          label: "How should air movers be documented?",
    ...
    {
      id: "dehumidifier-charge-reductions",
      heading: "Dehumidifier Charge Reductions",
      paragraphs: [
      ...
      links: [
        {
          label: "What supports dehumidifier charges?",
    ...
    {
      id: "hepa-filtration-and-air-scrubber-reductions",
      heading: "HEPA Filtration and Air Scrubber Reductions",
      paragraphs: [
      ...
      links: [
        {
          label: "What documentation supports HEPA filtration equipment?",
    ...
    {
      id: "specialty-drying-equipment-disputes",
      heading: "Specialty Drying Equipment Disputes",
      paragraphs: [
    ...
    {
      id: "missing-equipment-documentation",
      heading: "Missing Equipment Documentation",
      paragraphs: [
    ...
    {
      id: "missing-deployment-photos",
      heading: "Missing Deployment Photos",
      paragraphs: [
    ...
    {
      id: "weak-daily-monitoring-support",
      heading: "Weak Daily Monitoring Support",
      paragraphs: [
    ...
    {
      id: "equipment-removal-timing-disputes",
      heading: "Equipment Removal Timing Disputes",
      paragraphs: [
    ...
    {
      id: "revenue-impact-of-equipment-reductions",
      heading: "Revenue Impact of Equipment Reductions",
      paragraphs: [
      ...
      callout: {
        title: "Margin leak",
        body: "Two cut dehumidifier days plus one reduced air mover count plus one denied monitoring visit on a single residential file can exceed $1,000 — repeated across storm volume, that is operational margin, not adjuster personality.",
      },
      links: [
        {
          label: "Why water mitigation claims get underpaid",
    ...
    {
      id: "claims-ninja-equipment-recovery",
      heading: "How Claims Ninja supports equipment charge recovery",
      paragraphs: [
