...
const EN: HomeContent = {
  ...
  proof: {
    ...
    description:
      "Claims Ninja combines AI-assisted review, experienced supplement professionals, public adjuster support, and a centralized contractor platform to accelerate estimate delivery and supplement resolution — without an in-house estimator.",
    primaryCta: "Start Claim Review",
