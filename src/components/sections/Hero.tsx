...
export function Hero() {
  return (
    ...
    >
      ...
      <Container className="relative z-10 grid min-h-[100svh] grid-cols-1 items-center gap-10 pb-16 pt-32 sm:gap-12 sm:pb-20 sm:pt-36 lg:grid-cols-2 lg:gap-16 lg:pb-28 lg:pt-36">
