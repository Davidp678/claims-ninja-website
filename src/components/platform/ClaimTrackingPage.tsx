...
export function ClaimTrackingPage({ locale = "en" }: { locale?: Locale }) {
  const content = getPlatformModulesContent(locale).claimTracking;
  ...
  return (
    <>
      ...
      <SiteFaqSection {...SITE_FAQ.claimTracking} locale={locale} />
