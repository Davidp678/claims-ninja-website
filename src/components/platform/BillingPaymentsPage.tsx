...
export function BillingPaymentsPage({ locale = "en" }: { locale?: Locale }) {
  const content = getPlatformModulesContent(locale).billingPayments;
  ...
  return (
    <>
      ...
      <SiteFaqSection {...SITE_FAQ.billingPayments} locale={locale} />
