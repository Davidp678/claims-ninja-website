...
export function GuideMistakesTable({ mistakes }: GuideMistakesTableProps) {
  return (
    <>
        ...
        <table className="w-full min-w-[480px] text-left text-sm">
          <thead>
            <tr className="border-b border-white/10 bg-brand-surface/80">
              <th className="px-4 py-3 font-semibold text-zinc-300">Mistake</th>
              <th className="px-4 py-3 font-semibold text-zinc-300">Impact</th>
              <th className="px-4 py-3 font-semibold text-zinc-300">Correction</th>
            </tr>
          </thead>
          <tbody>
            {mistakes.map((row) => (
        ...
        {mistakes.map((row) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-300">
              <span className="font-medium text-zinc-500">Correction: </span>
              {row.correction}
            </p>
          </li>
        ))}
